...
<head>
	...
	<title>ANDROID & IOS APP DEVELOPMENT</title>
		...
		<div class="container ">
		    <div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="images/thinkdebug-mobileapp.jpg" alt=" ANDROID & IOS APP DEVELOPMENT" description=" ANDROID & IOS APP DEVELOPMENT" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Mobile-App-Development_prev_ui.png" alt=" Android App Development" description=" Android App Development" class="img-thumbnail">
					</div>
				</div>
	...
	<section class="cliping_service " >
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/MIndcob-15-1024x1024.png" alt=" iOS App Development" description=" iOS App Development" class="img-thumbnail">
					</div>
				</div>			
			</div>
		</div>
