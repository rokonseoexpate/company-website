		...
		<div class="container ">
		    <div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="images/8-Phase-of-the-WordPress-Web-Design-and-Development-Process-to-Follow.jpg" alt="WordPress Website SEO Services" description="WordPress Website SEO Services" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-12">
                	...
                	<p>4. Dynamic <a href="website_course.html" class="text-success">website</a> Development </p>
                	...
                	<p>9. And much more project you will create throughout this <a href="traning.html" class="text-success">course</a> </p>
                </div>
                <div class="col-12">
                	<p>In this course we will create real world projects, which will make you confident and will help you build complex web applications, while also helping you maintain your confidence on the <a href="jobs.html" class="text-success">job</a>.</p>
                </div>
            </div>
        </div>
    </section>
        	...
        	<div class="row">
        		<div class="col-md-4 marginbottom">
        			<div class="container shadow px-5 py-3 border-start border-5 border-success border-0">
			            <div class="row">
			            	<div class="col-12 pb-3 newudcode">
			                	<h6 class="text-center fs-3">Needed Software</h6>
				                <div class="border-bottom border-3 border-success">
				                </div>
			                </div>
        		...
        		<div class="col-md-4 marginbottom">
        			<div class="container shadow px-5 py-3 border-start border-5 border-warning border-0">
			            <div class="row">
			            	<div class="col-12 pb-3 newudcode">
			                	<h6 class="text-center fs-3">Job Opportunities</h6>
				                <div class="border-bottom border-3 border-success">
				                </div>
			                </div>
			                <div class="col-12">
			                	<p>1. Web Designer</p>
			                	<p>2. Font-End Developer</p>
			                	<p>3. WordPress Developer</p>
			                	<p>4. Full Stack Developer(WordPress)</p>
			                </div>
			            </div>
			        </div>
        		</div>
        		<div class="col-md-4">
        			<div class="container shadow px-5 py-3 border-start border-5 border-success border-0">
			            <div class="row">
			            	<div class="col-12 pb-3 newudcode">
			                	<h6 class="text-center fs-3">Marketplace</h6>
				                <div class="border-bottom border-3 border-success">
				                </div>
			                </div>
			                <div class="col-12">
