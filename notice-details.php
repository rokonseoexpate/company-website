				...
				<div class="col-12" style="z-index:500;">
					<div class="top_about_us_txt" style="z-index:500;">
						...
						<ol class="breadcrumb breadcumb_gph">
							...
							<li class="breadcrumb-item "><a href="notice.html" class="text-light">Notice</a></li>
            		...
            		<div class="recentno0tice">
	                    ...
	                    <div class="row ">
	                        ...
	                        <div class="col-sm-12 box" align="center">
	                            <iframe src="images/434851978_403671812407986_8393123070098562643_n.pdf" width="100%" height="800"></iframe>   
	                        </div>
	                    </div>
                    </div>
            	</div>
            		...
            		<div class="recent_notice pt-3 pb-5">
                        ...
                        <div class="row notice-row notice-border">
                            ...
                            <div class="col-sm-8 col-xs-8">
                            	<a href="notice_details.html"  class="margin-left-15">Eid Ul Fitr 2024</a>
                            </div>
                        </div>
                        <div class="row notice-row notice-border">
                            <div class="col-sm-2 col-xs-2 font-bold">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="notice" description=" notice">
                    </div>
                </div>
            </div>
        </div>
