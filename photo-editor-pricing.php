...
<head>
	...
	<title>Photo Editor Pricing </title>
		    ...
		    <div class="row">
		    	<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey"> <img src="images/Clipping-Path-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>				    
				  </ul>				 
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Photo-Background-Removing-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Image-Masking-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey">$0.35 USD</li>
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Shadow-Making-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Ghost-Mannequin-Effect-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Photo-Retouching-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey">$0.50 USD</li>
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Color-Correction-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/E-Commerce-Photo-Editing-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Jewelry-Retouching-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey">$1.00 USD</li>
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Wedding-Photo-Editing-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey">$2.00 USD</li>
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Photo-Restoration-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li class="grey">$1.00 USD</li>
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Real-Estate-Photo-Editing.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Image-Manipulation-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Raster-to-Vector-Conversion-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>
				<div class="columns">
				  <ul class="price">
				    ...
				    <li>Starting Price</li>
				    <li class="grey"><img src="images/Illustrator-Art-Work-Service.png" alt="  Photo Editor" description=" Photo Editor"></li>
				  </ul>
				</div>	        
		    </div>
		</div>		
