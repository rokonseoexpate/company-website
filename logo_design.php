		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Logo-design-banner-image.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
					</div>
				</div>
			</div>
		</div>
		  	...
		  	<div class="row text-center text-lg-start">
			    <div class="col-md-4 col-6">
			      <a href="#" class="d-block mb-4 h-100">
			        <img class="img-fluid " src="images/4-1-300x208.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
			      </a>
			    </div>
			    <div class="col-md-4 col-6">
			      <a href="#" class="d-block mb-4 h-100">
			        <img class="img-fluid " src="images/avvafitness_JPEG-300x213.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
			      </a>
			    </div>
			    <div class="col-md-4 col-6">
			      <a href="#" class="d-block mb-4 h-100">
			        <img class="img-fluid " src="images/2-2-300x213.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
			      </a>
			    </div>
			    <div class="col-md-4 col-6">
			      <a href="#" class="d-block mb-4 h-100">
			        <img class="img-fluid " src="images/1-5-300x208.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
			      </a>
			    </div>
			    <div class="col-md-4 col-6">
			      <a href="#" class="d-block mb-4 h-100">
			        <img class="img-fluid " src="images/1-4-300x213.jpg" alt="Logo Designs Service" description=" Logo Designs Service">
			      </a>
			    </div>
		  	</div>
		</div>
