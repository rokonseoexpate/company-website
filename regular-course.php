...
<body>
					...
					<div class="container mt-2">
					  	<div class="row">
					    	<div class="col-md-3 col-sm-6">
					    		<a href="website_course.html">
					      		<div class="card card-block">
					    			<img src="images/ecommerce-website2.jpg" alt=" Regular Course" description=" Regular Course">
					        		<div class="card-body">
					        			<h5 class="card-title ">Website</h5>
					    	...
					    	<div class="col-md-3 col-sm-6">
					    		<a href="graphics_course.html">
					      		<div class="card card-block">
					    			<img src="images/corporate-website2.jpg" alt=" Regular Course" description=" Regular Course">
					        		<div class="card-body">
					        			<h5 class="card-title">Graphic Design</h5>
					    	...
					    	<div class="col-md-3 col-sm-6 mtrespon">
					    		<a href="digital_marketing_course.html">
					      		<div class="card card-block">
					    			<img src="images/Bloging-website.jpg" alt=" Regular Course" description=" Regular Course">
					        		<div class="card-body">
					        			<h5 class="card-title">Digital Marketing</h5>
					    	...
					    	<div class="col-md-3 col-sm-6 mtrespon">
					      		<a href="microsoft_office_course.html">
					      		<div class="card card-block">
					    			<img src="images/news-website.jpg" alt=" Regular Course" description=" Regular Course">
					        		<div class="card-body">
					        			<h5 class="card-title">Microsoft Office</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt=" Regular Course" description=" Regular Course">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt=" Regular Course" description=" Regular Course" width="100%">
                </div>
            </div>
        </div>
    </section>
