		...
		<div class="container ">
		    <div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="images/8-Phase-of-the-WordPress-Web-Design-and-Development-Process-to-Follow.jpg" alt="Amazon " description="Amazon" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-12">
                	...
                	<p>2. Web Development Using <a href="php_course.html" class="text-success">PHP</a> (OOP)</p>
                	<p>3. Web Development Using <a href="python_course.html" class="text-success">Python & Django</a></p>
                	<p>4. Web Development Using <a href="laravel_course.html" class="text-success">Laravel</a></p>
