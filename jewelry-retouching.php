...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-12" style="z-index:500;">
					...
					<div class="pb-2 pt-2 text-light"><h4 class="fs-1 fw-bold">Jewelry Retouching Service</h4></div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2 pt-2"><h6>What is Jewelry Retouching?</h6></div>
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Jewelry-Retouching-Service-3.webp" alt="Jewelry Retouching" description=" Jewelry Retouching" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Jewelry-Retouching-Service-4.png" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Jewelry-Retouching-Service-2.png" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Jewelry-Retouching-Service-3.webp" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Jewelry-Retouching-Service-1.png" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Jewelry-Retouching-Service-6.png" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Jewelry-Retouching-Service-5.png" alt="Jewelry Retouching" description=" Jewelry Retouching" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            <div class="row">
                <div class="newudcode pb-2"><h5>Jewelry Retouching Service in the SEO Expate BD Ltd</h5></div>
                <div class="pb-5 border-bottom border-success border-2">
                    <p>At <a href="index.html" class="text-success">SEO Expate</a> BD Ltd, Jewelry Retouching is like a magic workshop. Here, every piece of jewelry gets a sparkling makeover. Our retouchers, work on each photo, carefully removing any tiny scratches or marks that shouldn't be there. We also make sure the colors of the gems look bright and true. Besides, we add just the right amount of shine so that every detail stands out. We use software to bring out the best in every piece. This process is super important for online shopping. By making each piece of jewelry look its best, we help customers fall in love with what they see.</p>                   
                </div>
            </div>
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Jewelry-Retouching-Service.png" alt="Jewelry Retouching" description=" Jewelry Retouching" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
	...
	<section class=" graphicdesigns_content" style="background: var(--button-bg-hover-color);">
        <div class="container">
            <div class="row">
            	<div class="col-12">
					<div class="newudcode pb-2"><h5 class="text-light">How We Do Jewelry Retouch Service</h5></div>
	                <div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="Jewelry Retouching" description=" Jewelry Retouching" width="100%">
                </div>
            </div>
        </div>
    </section>
