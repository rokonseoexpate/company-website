            ...
            <div class="row">
                ...
                <div class="col-md-6 pt-5 ">
                    <div class="upload_files uploadfiles">
                        ...
                        <div class="pt-3"><a class="text-dark fw-bold" href="clipping-path.php">CLIPPING PATH</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="background-remove.php">PHOTO BACKGROUND REMOVING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="image-masking.php">IMAGE MASKING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="shadow-making.php">SHADOW MAKING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="ghost-mannequin.php">GHOST MANNEQUIN EFFECT</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="photo-retouching.php">PHOTO RETOUCHING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="color-correction.php">COLOR CORRECTION</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="ecommerce-photo-edit.php">E-COMMERCE PHOTO EDITING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="jewelry-retouching.php">JEWELRY RETOUCHING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="wedding-photo.php">WEDDING PHOTO EDITING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="photo-restoration.php">PHOTO RESTORATION</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="real-estate-photo.php">REAL ESTATE PHOTO EDITING</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="image-manipulation.php">IMAGE MANIPULATION</a></div>
                        <div class="pt-2"><a class="text-dark fw-bold" href="raster-vector.php">RASTER TO VECTOR CONVERSION</a></div>
                    </div>
                </div>
            </div>
        </div>
...
include 'includes/our-services.php'
