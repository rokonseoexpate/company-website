		...
		<div class="container">
			<div class="row">
					...
					<form class="row g-3">
						...
						<div class="col-12">
							...
							<select name="" id="stuf" style="width: 100%;" class="form-control">
								...
								<option value="">18 Hours</option>
								<option value="">24 Hours (Standard Turnaround)</option>
								<option value="">36 Hours</option>
				...
				<div class="col-md-6 pt-5 ">
					<div class="upload_files uploadfiles">
						<h3 class="fs-1">Our Services</h3>
						<div class="pt-3"><a class="text-dark fw-bold" href="clipping_path.html">CLIPPING PATH</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="background_remove.html">PHOTO BACKGROUND REMOVING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="image_masking.html">IMAGE MASKING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="shadow_making.html">SHADOW MAKING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="ghost_mannequin.html">GHOST MANNEQUIN EFFECT</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="photo_retouching.html">PHOTO RETOUCHING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="color_correction.html">COLOR CORRECTION</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="ecommerce_photo_edit.html">E-COMMERCE PHOTO EDITING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="jewelry_retouching.html">JEWELRY RETOUCHING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="wedding_photo.html">WEDDING PHOTO EDITING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="photo_restoration.html">PHOTO RESTORATION</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="real_estate_photo.html">REAL ESTATE PHOTO EDITING</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="image_manipulation.html">IMAGE MANIPULATION</a></div>
						<div class="pt-2"><a class="text-dark fw-bold" href="raster_vector.html">RASTER TO VECTOR CONVERSION</a></div>
					</div>
				</div>
			</div>
		</div>
