...
<body>
	...
	<section class="top-body app_development" style="background-image: url(images/72d076db-72f4-4121-a467-0195035b7f60.jpg); background-repeat: no-repeat;  background-position: center center; background-size: cover; padding-top: 20px;">		
		<div class="container ">
		    <div class="row">
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-md-6">
                	...
                	<p>4. Skill/Career <a href="software_development_course.htmls" class="text-success">Development Services</a> </p>
                </div>
                <div class="col-md-6">
                	<div class="clip_img">
						<img src="images/Our-Training-Centers.png" alt="v " description="training programs" class="img-thumbnail">
					</div>
                </div>
            </div>
        </div>
		...
		<div class="container">
			<div class="row">
				<div class="Our_Branches_txt ">
					<div class="Our_Departments bg-0 p-0" style="background: unset;"><h6 class="text-start ">Our Course / Training Services</h6></div>
					<hr>
				</div>
				<div class="col-md-4 pt-5">
					<a href="regular_course.html">
						<div class="card">
				      	<img src="images/ecommerce-website2.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      	<div class="card-body">
				...
				<div class="col-md-4 pt-5">
					<a href="graphics_course.html">
						<div class="card hover-zoom">
				      		<img src="images/corporate-website2.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      		<div class="card-body">
				...
				<div class="col-md-4 pt-5">
					<a href="digital_marketing_course.html">
						<div class="card">
				      		<img src="images/Bloging-website.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					<a href="software_development_course.html">
						<div class="card">
				      	<img src="images/news-website.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      	<div class="card-body">
				...
				<div class="col-md-4 pt-5">
					<a href="server_administration_course.html">
						<div class="card hover-zoom">
				      	<img src="images/ecommerce-website2.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      	<div class="card-body">
			...
			<div class="row ">
				<div class="col-md-4 pt-5">
					<a href="app_development_course.html">
						<div class="card">
				      		<img src="images/news-website.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      		<div class="card-body">
				...
				<div class="col-md-4 pt-5">
					<a href="microsoft_office_course.html">
						<div class="card">
				      		<img src="images/education-website.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      		<div class="card-body">
				...
				<div class="col-md-4 pt-5">
					<a href="it_security_course.html">
						<div class="card hover-zoom">
				      	<img src="images/entertainment-website.jpg" class="card-img-top" alt="Training Services " description="Training Services">
				      	<div class="card-body">
					...
					<div class="container mt-2">
					  	<div class="row">
					    	<div class="col-md-3 col-sm-6">
					    		<a href="website_course.html">
					      		<div class="card card-block">
					    			<img src="images/ecommerce-website2.jpg" alt="Md-Mizanur-Rahman">
					        		<div class="card-body">
					        			<h5 class="card-title ">Website</h5>
					        			<p class="card-text">Web Design & Development</p>
					        		</div> 
					    	...
					    	<div class="col-md-3 col-sm-6">
					    		<a href="graphics_course.html">
					      		<div class="card card-block">
					    			<img src="images/corporate-website2.jpg" alt="Mst-Razia-Sultana">
					        		<div class="card-body">
					        			<h5 class="card-title">Graphic Design</h5>
					        			<p class="card-text">Photoshop, Illustrator, etc</p>
					        		</div> 
					    	...
					    	<div class="col-md-3 col-sm-6">
					    		<a href="digital_marketing_course.html">
					      		<div class="card card-block">
					    			<img src="images/Bloging-website.jpg" alt="Shajahan-Ali-Director">
					        		<div class="card-body">
					        			<h5 class="card-title">Digital Marketing</h5>
					        			<p class="card-text">Digital Marketing Training</p> 
					        		</div>
					    	...
					    	<div class="col-md-3 col-sm-6">
					      		<a href="microsoft_office_course.html">
					      		<div class="card card-block">
					    			<img src="images/news-website.jpg" alt="Shajahan-Ali-Director">
					        		<div class="card-body">
					        			<h5 class="card-title">Microsoft Office</h5>
					        			<p class="card-text">Microsoft Office Specialist</p> 
					        		</div>
