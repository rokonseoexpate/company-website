        ...
        <tbody class="border-top border-0 border-white border-bottom border-3">
          <tr>
            <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                <p>Artificial Intelligence Foundation (AIF)</p>
              </span></td>
          ...
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Certified Machine Learning Associate (CMLA)</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
            <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
          </tr>
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Certified Artificial Intelligence Expert (CAIE)</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
            <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
          </tr>
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p> Certified Deep Learning Expert (CDLE )</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
            <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
          </tr>
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Certified Natural Language Processing Expert (CNLPE)</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
            <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
          </tr>
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Artificial Intelligence Certified Executive (AICE )</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
            <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
          </tr>
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Certified Computer Vision Expert (CCVE )</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
            <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
          </tr>
    ...
    <div class="pricing-table table-responsive">
      <table class="table border shadow ">
        ...
        <tbody class="border-top border-0 border-white border-bottom border-3">
          ...
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>ML Engineering – Deep Learning & Big Data</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
            <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
          </tr>
    ...
    <div class="pricing-table table-responsive">
      <table class="table border shadow ">
        ...
        <tbody class="border-top border-0 border-white border-bottom border-3">
          ...
          <tr>
            <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                <p>Robotics: Computational Motion Planning</p>
              </span></td>
            <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
            <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
          </tr>
