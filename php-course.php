...
?>
		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						<h1 class="marginbottom" style="font-size: 45px; line-height: 55px;">Web Development With PHP</h1>	
						<p style="margin-top: -15px; text-align: justify;">Currently, the demand for web design and development is very high in the market places and is constantly increasing and will increase in the future. 60 percent of Bangladesh's web development market is occupied by PHP and PHP frameworks! Learn PHP to build your position in this huge market.</p>						
						<p style="margin-top: -15px; text-align: justify;">Opportunities to work in the country and abroad are increasing. You can also start your own job/business by doing this course. Online marketplaces can work.</p>						
					</div>
					<div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="frontend/images/php-web-development.png" alt="Web Development With PHP" description=" Web Development With PHP" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
				...
				<div class="col-12" style="z-index:500;">
					<div class="top_about_us_txt" style="z-index:500;">
						...
						<ol class="breadcrumb breadcumb_gph">
							...
							<li class="breadcrumb-item active text-light" aria-current="page">PHP</li>
						</ol>
						</nav>
					</div>			
				</div>
	...
	<section class=" graphicdesigns_content">
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-12">
                	<p>1. PHP</p>
                	<p>2. Advance PHP(OOP) </p>
                	<p>3. SQL (Structured Query Language) </p>
                	<p>4. MySQL Database </p>
                	<p>5. Apache Web Server </p>
                	<p>6. Manage cPanel On The Server </p>
                	<p>7. Login/Registration System </p>
                	<p>8. Student management system </p>
                	<p>9. Modern Admin Panel</p>
                	<p>10. Dynamic Blog Website</p>
                </div>
                <div class="col-12">
        	...
        	<div class="row">
        			...
        			<div class="container shadow px-5 py-3 border-start border-5 border-success border-0">
			            <div class="row">
			            	<div class="col-12 pb-3">
								<div class="newudcode"><h6 class="text-center">Needed Software</h6></div>
				                <div class="border-bottom border-3 border-success">
				                </div>
			                </div>
			                <div class="col-12">
			                	<p>1. Visual Studio Code / Sublime Text / Notepad++</p>
			                	<p>2. Xampp / Wampp</p>
			                	<p>3. Web Browser</p>
			                </div>
			            </div>
        		...
        		<div class="col-md-6">
        			<div class="container shadow px-5 py-3 border-start border-5 border-warning border-0">
			            <div class="row">
			            	<div class="col-12 pb-3">
								<div class="newudcode"><h6 class="text-center">Marketplace</h6></div>
				                <div class="border-bottom border-3 border-success">
				                </div>
			                </div>
			                <div class="col-12">
	...
	<section class=" graphicdesigns_content ptunset" style="padding-top: unset;">
        <div class="container shadow px-5 py-5 ">
            <div class="row">
            	<div class="col-12 pb-5 ">
					<div class="newudcode"><h6 class="text-center">Job Opportunities</h6></div>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
                	<p>1. Full-Stack Web Developer</p>
                	<p>2. Back-End Developer</p>
                	<p>3. PHP Developer</p>
                	<p>4. Software Engineer </p>
                </div>
            </div>
        </div>
    </section>
	...
	<section class=" graphicdesigns_content ptunset" style="padding-top: unset;">
        <div class="container shadow px-5 py-5">
            <div class="row">
            	<div class="col-12 pb-5">
                	<h4 class="text-center">Additional facilities</h4>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="frontend/images/95991_prev_ui.png" alt="Web Development With PHP" description=" Web Development With PHP">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="frontend/images/Payment-method-banner-image-1024x73.webp" alt="Web Development With PHP" description=" Web Development With PHP" width="100%">
                </div>
            </div>
        </div>
    </section>
