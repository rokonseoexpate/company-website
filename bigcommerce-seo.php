		    	...
		    	<div class="col-md-7 ecomresp" style="z-index:500;">
					...
					<div class="row">
						...
						<div class="col-md-2 ecomrespons">
							<img src="images/google-seo-proposal-audit.png.webp" alt=" BigCommerce SEO Services" description=" BigCommerce SEO Services" class="img-fluid" >
						</div>
					</div>	
				</div>
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500;" >
					<img src="images/Untitled-1 (1).webp" alt=" BigCommerce SEO Services" description=" BigCommerce SEO Services" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/seo-strategy.jpg" alt=" BigCommerce SEO services agency" description="BigCommerce SEO services agency" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
