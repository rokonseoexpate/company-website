		...
		<div class="row">
			<div class="col-12" style="z-index:500;">
				...
				<div class="pb-2 pt-2 text-light">
					<h4 class="fs-1 fw-bold">Photo Retouching Service</h4>
				</div>
		...
		<div class="row">
			<div class="col-md-6" style="z-index:500;">
				<div class="cliping_service_txt pb-2 pt-2">
					<h6>Our Photo Retouching Project</h6>
				</div>
...
<section class=" graphicdesigns_content" style="background: var(--button-bg-hover-color);">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="newudcode">
					<h5 class="text-light">Budget-Friendly Photo Retouching Service ($1.99 each image)</h5>
				</div>
				<div>
