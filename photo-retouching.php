		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Photo-Retouching-Service-3.png" alt=" Photo Retouching" description=" Photo Retouching" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Photo-Retouching-Service-1.png" alt=" Photo Retouching" description=" Photo Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Photo-Retouching-Service-2.png" alt=" Photo Retouching" description=" Photo Retouching">
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Retouching-Service-3.png" alt=" Photo Retouching" description=" Photo Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Retouching-Service-4.webp" alt=" Photo Retouching" description=" Photo Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Retouching-Service-5.png" alt=" Photo Retouching" description=" Photo Retouching" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Retouching-Service-6.png" alt=" Photo Retouching" description=" Photo Retouching" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Photo-Retouching-Service.png" alt=" Photo Retouching" description=" Photo Retouching" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
