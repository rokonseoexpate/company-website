		    ...
		    <div class="row">
		    	<div class="col-12" style="z-index:500;">
		    		<div class="top_body_txt_part">
						...
						<p>The journey of <a href="index.html" class="text-success">SEO Expate</a> started in 2013. Riseup Labs has provided technology solutions to global businesses for over 10 years. It has been established as a next-generation global IT service and technology solution provider company to help enterprises reimagine their business and navigate digital transformation. Let’s explore our long history of <a href="award.html" class="text-success">success!</a></p>
					</div>
					<div class="top-body-button pt-3">
						<div class="">
							<a type="button" href="about.html">About SEO Expate</a>
						</div>
					</div>	
				</div>			
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="accelerating_innovation_text">
						...
						<p class="pt-3">In the journey of <a href="index.html" class="text-success">SEO Expate</a>, it has become a major technology solution provider for brands like UNICEF Bangladesh, Robi Axiata Limited, BBC Media Action, Ministry of Women and Children Affairs, ICT Division and many large corporations globally.</p>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="top-body-button pt-5 text-center">
					<a type="button" href="about.html">Know More About Our Journey</a>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="top_body_explore_tab">
       <div class="container">
           <div class="row">
                   ...
                   <p><a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. started the journey in Game Development and after a successful journey, we have established as a next-generation globnal IT service and technology solutions provider company. Explore our journey of success since 2013.</p>                
               	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<!-- <div class="top-body-button pt-3">
						<a type="button" href="contact.html">See More </a>
					</div> -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="top-body-button pt-3 pt-4">
					<a type="button" href="contact.html">Make Your Own Story</a>
				</div>				
			</div>
		</div>
	</section>
