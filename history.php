...
<body>
	...
	<section class="top-body top-history" style="background-image: url(frontend/images/1.jpg); background-repeat: no-repeat;  background-position: center center; background-size: cover;   ">
		<div class="container ">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="updatecode">
						<h6 class="" style="padding-bottom: unset; text-align: left !important;">Our <span> One Mission</span></h6>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="Our_Great_Start_txt pb-5">
					<div class="updatecode">
						<h6 class="" style="padding-bottom: unset;">Our Great Start</h6>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="ptc_txt">
					...
					<div class="updatecode">
						<h6 class="text-dark" style="padding-bottom: unset;">Delivering IT Solutions Globally</h6>
					</div>
	...
	<section class="top-slider-part">
		<div class="container ">
			<div class="row">
				<div class="updatecode">
					<h6 style="padding-bottom: unset;"><span>Our </span> Reliable Customers and Associates</h6>
				</div>
			...
			<div class="row">
				<div class="top_featured_txt">
					<div class="updatecode pb-3">
						<h6 style="padding-bottom: unset;">We're Highlighted On</h6>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="top_awards_txt">
					<div class="updatecode pb-3">
						<h6 style="padding-bottom: unset;">Achievements and Recognitions</h6>
					</div>
