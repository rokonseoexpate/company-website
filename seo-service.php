...
?>
		    ...
		    <div class="row">
		    	<div class="col-12" style="z-index:500;">
		    		<div class="top_body_txt_part">
						...
						<p style="text-align:justify;">Since 2010, SEO Expate Bangladesh Ltd. has provided tested SEO packages and campaigns that have resulted in page-one rankings, increased organic traffic, and increased conversions. When offering SEO services, there are numerous aspects you must consider. </p>	
						<div class="app_list">
							<p class="text-light"><span><i class="fa-solid fa-check-double"></i></span>Keyword Research and Optimization</p>
							<p class="text-light"><span><i class="fa-solid fa-check-double"></i></span>SEO tactics for eCommerce that concentrate on leads and sales</p>
							<p class="text-light"><span><i class="fa-solid fa-check-double"></i></span> Monthly Detailed Reporting</p>
						</div>					
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Why Choose Our Proven SEO Strategies?</h4></div>
					<p class="pt-3" >SEO Expate doesn't just offer empty promises. Our data-driven strategies and transparent reporting show you exactly how your rankings are improving. Here are some of the reasons why you need to take services from us. </p>
					<div class="app_list">
							...
							<p class=""><span><i class="fa-solid fa-check-double"></i></span>SEO Expate Bangladesh Ltd.’s SEO team is one of the largest in the whole world.</p>
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="frontend/images/1648113590-new4.jpg" alt="image" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service " >
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="frontend/images/1616598641645.jpg" alt="image" class="img-thumbnail">
					</div>
				</div>
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2 pt-2"><h4>What SEO services are included in SEO packages?</h4></div>
	...
	<section class="cliping_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2"><h4>SEO Packages for Various Other Platforms</h4></div>
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="frontend/images/expert-tips-for-small-business-61c4350ed5891-sej.webp" alt="image" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container shadow py-5 px-5">
            ...
            <div class="row GlobalSEO pt-5 text-center">
            	<div class="col-md-4">
	...
	<section class="top_body_explore_tab">
       <div class="container">
           <div class="row">
                   ...
                   <h3>What Our Web optimization Administration in bd will Offer You?</h3>
	...
	<section class="seo_bannar">
		<div class="container">
			<div class="row">
				<img src="frontend/images/off-page-search-engine-optimization_prev_ui.png" alt="image" class="img-fluid">
			</div>
		</div>
	</section>
	...
	<section class="accordion_service">
		<div class="container">
			<div class="row">
				<h4 class="text-center pb-5 fs-2">FAQ’s of SEO Packages & Services:</h4>
			    <div id="accordion">
			      <div class="accordion-item">
			        ...
			        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
			          <div class="accordion-body">At SEO Expate Bangladesh Ltd., we offer a comprehensive range of SEO services, including: <br>
