...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					...
					<p class="pt-3" ><a href="index.html" class="text-success">SEO Expate</a> doesn't just offer empty promises. Our data-driven strategies and transparent reporting show you exactly how your rankings are improving. Here are some of the reasons why you need to take services from us. </p>
					<div class="app_list">
							...
							<p class=""><span><i class="fa-solid fa-check-double"></i></span><a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd.’s SEO team is one of the largest in the whole world.</p>
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/1648113590-new4.jpg" alt=" SEO Services" description=" SEO Services" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service " >
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/1616598641645.jpg" alt=" SEO Services" description=" SEO Services" class="img-thumbnail">
					</div>
				</div>
	...
	<section class="cliping_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/expert-tips-for-small-business-61c4350ed5891-sej.webp" alt=" SEO Services" description=" SEO Services" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="seo_bannar">
		<div class="container">
			<div class="row">
				<img src="images/off-page-search-engine-optimization_prev_ui.png" alt=" SEO Services" description=" SEO Services" class="img-fluid">
			</div>
		</div>
	</section>
			    ...
			    <div id="accordion">
			      <div class="accordion-item">
			        ...
			        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
			          <div class="accordion-body">At <a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd., we offer a comprehensive range of SEO services, including: <br>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt=" SEO Services" description=" SEO Services">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt=" SEO Services" description=" SEO Services" width="100%">
                </div>
            </div>
        </div>
    </section>
