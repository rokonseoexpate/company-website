...
<?php include 'includes/photo-editing-nav.php' ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12" style="z-index:500;">
                    ...
                    <div class="pb-2 pt-2 text-light"><h4 class="fs-1 fw-bold">Image Manipulation Service</h4></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="z-index:500;">
                    <div class="cliping_service_txt pb-2 pt-2"><h6>Our Image Manipulation Project</h6></div>
                ...
                <div class="col-md-6" style="margin: auto;">
                    <div class="clip_img">
                        <img src="images/Image-Manipulation-Service-6.png" alt="Image Manipulation" description=" Image Manipulation" class="img-thumbnail">
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="owl-carousel">
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-1.png" alt="Image Manipulation" description=" Image Manipulation" >
                            </div>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-2.png" alt="Image Manipulation" description=" Image Manipulation" >
                            </div>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-3.png" alt="Image Manipulation" description=" Image Manipulation">
                            </div>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-4.png" alt="Image Manipulation" description=" Image Manipulation" >
                            </div>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-5.webp" alt="Image Manipulation" description=" Image Manipulation" >
                            </div>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/Image-Manipulation-Service-6.png" alt="Image Manipulation" description=" Image Manipulation" >
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                    <img src="images/Image-Manipulation-Service.png" alt="Image Manipulation" description=" Image Manipulation" class="img-thumbnail">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class=" graphicdesigns_content" style="background: var(--button-bg-hover-color);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="newudcode pb-2"><h5 class="text-light" >Budget-Friendly Image Manipulation Service ($3.00 each image)</h5></div>
                    <div>
