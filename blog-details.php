		    ...
		    <div class="row">
				...
				<div class="col-md-6 pt-4">
					<div class="web_service_img">
						<img src="images/Seop-Expate- blanket-distribution-thumbnail.jpg" alt=" Seop-Expate- Blanket-Distribution" description=" Seop-Expate- Blanket-Distribution" class="img-thumbnail">
					</div>
				</div>			
			</div>			
		</div>				
		...
		<div class="container">
			<div class="row">
				<div class="what_you_need_txt">
					<p><a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. distributed winter clothes to homeless people, who were suffering in winter. This IT company contributes to Corporate Social Responsibility (CSR) every year by helping the helpless. Following this, team SEO Expate Bangladesh Ltd. focuses on sharing the winter warmth with homeless people each year.</p>
					<p>On the evening of 17th January 2023, some of the team members of <a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. distributed winter clothes to homeless people. More than 40 people received blankets and winter clothes on this occasion.</p>
					<div class="blog_det_img">
						<img src="images/Seop-Expate- blanket-distribution-thumbnail.jpg" alt=" seo expate" description=" seo expate" class="img-thumbnail">
				...
				<div class="col-md-6 pt-4">
					<div class="card">
						<div class="card-img blog_det_img">
							<img src="images/Taka Bitoron.jpg" alt=" seo expate" description=" seo expate" class="img-thumbnail">
						</div>
						<div class="card-body">
							...
							<div class="button ">
								<a href="index.html" class="text-success fw-bold">SEO Expate</a>
							</div>
						</div>
					</div>
				</div>
