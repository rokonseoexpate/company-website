...
! function (c, M) {
  ...
  function z(c) {
    var M = 0,
      ...
      a = 0,
      p = 1;
    for (45 === c.charCodeAt(0) && (p = -(M = 1)); M < o.length; M++) a = 60 * a + q(o.charCodeAt(M));
  ...
  function t(c) {
    var M, A, o, z;
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) z = T(A = (o = c[M].split("|"))[0]), a[z] = c[M], i[z] = A, B(z, o[2].split(" "))
  }
  ...
  b.tz = S, b.defaultZone = null, b.updateOffset = function (c, M) {
    ...
    if (void 0 === c._z && (o && E(c) && !c._isUTC && (c._d = b.utc(c._a)._d, c.utc().add(o.parse(c), "minutes")), c._z = o), c._z)
