		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						<h1 class="marginbottom" style="font-size: 45px; line-height: 55px;">Professional Graphics Design With Freelancing</h1>	
						<p style="margin-top: -15px; text-align: justify;">Currently the most powerful and popular sector among freelancing is Graphics Design.</p>											
						<p style="margin-top: -15px; text-align: justify;">Our course is designed in such a way that one can easily work from basic to advanced level and can easily build his career in the world of Freelancing.</p>											
					</div>
					<div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="frontend/images/featured-guide2.webp" alt=" Graphics Design With Freelancing" description=" Graphics Design With Freelancing" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
	...
	<section class=" graphicdesigns_content">
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
                    <img src="images/featured-guide2.webp" alt=" Graphics Design With Freelancing" description=" Graphics Design With Freelancing" class="img-thumbnail">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
                <div class="col-12 pb-5">
                    <h4 class="text-center">What will be taught in this course</h4>
                    <div class="border-bottom border-3 border-success">
                    </div>
                </div>
                <div class="col-12">
                    <p>1. Design Principles and Elements</p>
                    <p>2. Logo Designing</p>
                    <p>3. Brochure Design</p>
                    <p>4. Colour Theory </p>
                    <p>5. Brand identity Design</p>
                    <p>6. Typography</p>
                    <p>7. Business card design, banner, poster, logo, billboard, social media cover photo etc. </p>
                    <p>8. Clipping path, multipath, color correction. </p>
                    <p>9. Freelancing, Design Hill, Upwork, Fiver etc.</p>
                    <p>10. How to make active and passive income by designing graphics.</p>
                    <p>11. How to make life time income.</p>
                </div>
                <div class="col-12">
