...
<body>
		    	...
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
					...
					<div class="row">
						...
						<div class="col-md-2 ecomrespons">
							<img src="images/google-seo-proposal-audit.png.webp" alt="Professional Google Ads " description=" Professional Google Ads " class="img-fluid" >
						</div>
					</div>	
				</div>
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500;" >
					<img src="images/Home-8-Banner-Image.jpg" alt="Professional Google Ads " description=" Professional Google Ads " class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/seo_reporting_dashboard_data_studio.webp" alt="Google Ads Campaign" description=" Google Ads Campaign" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/63b7df7651c786482fc4f0b5_How to sell my products on google shopping.jpg" alt="Google Ads Campaign" description=" Google Ads Campaign" class="img-thumbnail">
					</div>
				</div>
				<div class="col-md-6" style="z-index:500;">
	...
	<section class="cliping_service">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/ecommerce-sales-instagram-ad-examples.webp" alt="Google Ads Campaign" description=" Google Ads Campaign"  class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="Google Ads Campaign" description=" Google Ads Campaign" >
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="Google Ads Campaign" description=" Google Ads Campaign"  width="100%">
                </div>
            </div>
        </div>
    </section>
