      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Understanding Cisco Cybersecurity Operations Fundamentals (CBROPS)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Performing CyberOps Using Cisco Security Technologies (CBRCOR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Conducting Forensic Analysis and Incident Response Using Cisco Technologies for CyberOps (CBRFIR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Implementing and Operating Cisco Service Provider Network Core Technologies (SPCOR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Implementing and Operating Cisco Data Center Core Technologies (DCCOR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Implementing and Operating Cisco Security Core Technologies (SCOR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Implementing and Operating Cisco Collaboration Core Technologies (CLCOR)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Developing Applications and Automating Workflows using Cisco Platforms (DEVASC)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p>Juniper Junos, Associate (JNCIA-Junos)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Juniper Design, Associate (JNCDA)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Enterprise Routing and Switching, Specialist (JNCIS-ENT)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Juniper Security, Associate (JNCIA-SEC)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Juniper Security, Specialist (JNCIS-SEC)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Service Provider Routing and Switching, Specialist (JNCIS-SP)</p>
                </span></td>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Service Provider Routing and Switching, Expert (JNCIE-SP)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Juniper Security, Expert (JNCIE-SEC)</p>
                </span></td>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p> MikroTik Certified Network Associate</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> MikroTik Certfied Security Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> MikroTik Certified Traffic Control Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>MikroTik Certified User Management Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>MikroTik Certified Inter-Networking Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>MikroTik Certified IPv6 Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>MikroTik Certified Wireless Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>MikroTik Certified Switching Engineer</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p>Fortinet FortiOS Network Security Professional</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Fortinet FortiAnalyzer Network Security Analyst</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Fortinet FortiADC Network Security Specialist</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Fortinet Advanced Analytics Network Security Architect</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Fortinet Fortinet Network Security Expert</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Installing and Configuring Server</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">30 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Designing and Implementing Server infrastructure</p>
                </span></td>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p> Implementing an Advanced Server Infrastructure</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">32 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p> Microsoft Azure Infrastructure and Deployment</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Microsoft Certified: Data Analyst Associate</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Red Hat Certified Engineer (RHCE) exam for Red Hat Enterprise Linux 8</p>
                </span></td>
            ...
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Red Hat Certified Specialist in Ansible Automation exam</p>
                </span></td>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p>CDCP (Certified Data Centre Professional)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>CDCS (Certified Data Centre Specialist)</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>CDCE (Certified Data Centre Expert )</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>CITP (Certified Information Technology Professional )</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
      ...
      <div class="pricing-table table-responsive">
        <table class="table border shadow ">
          ...
          <tbody class="border-top border-0 border-white border-bottom border-3">
            <tr>
              <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title">
                  <p>VCPS-DCV VMWARE vSphere,Install,Fonfigure, Manage [V5.1]</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Associate VMware Network Virtualization</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Certified Professional – Network Virtualization</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs </td>
              <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Certified Advanced Professional – Network Virtualization</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Associate VMware Data Center Virtualization</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Certified Professional – Data Center Virtualization</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>VMware Certified Advanced Professional – Data Center Virtualization Design</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
            <tr>
              <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title">
                  <p>Associate VMware Cloud Management Automation</p>
                </span></td>
              <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
              <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
            </tr>
