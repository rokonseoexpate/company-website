...
<head>
	...
	<title>Server & Network Administration</title>
...
<body>
		...
		<div class="container ">
		    <div class="row">
				...
				<div class="col-md-5 m-auto pt-5 ecomrespp" style="z-index:500; ">
					<img src="images/images (2).jpg" alt="Server & Network Administration " description="Server & Network Administration" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="Server & Network Administration " description="Server & Network Administration">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="Server & Network Administration " description="Server & Network Administration" width="100%">
                </div>
            </div>
        </div>
    </section>
