        ...
        <div class="container shadow py-5 px-5 " style="border-left:15px solid var(--secondary-text-color); background: #fff;">
            <div class="row ">
            	<div class="col-12">
	                ...
	                <div><p>At our agency, we've learned that providing personalized technical services works better for our clients than fixed SEO packages. Moreover, <a href="/" class="text-success">SEO Expate</a> is one of the leading SEO service providers in the global market.  </p></div>
