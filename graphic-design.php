...
<!--================================photo editor sub Header section end here=======================-->
    ...
    <section class="cliping_service photo_edit_all_service graphicdesigns" style="background: unset; background-image: url(images/Graphic-Design-banner.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6" style="z-index:500;">
                    <div class="clip_img">
                        <img src="images/Graphic-Design-service-image-1024x768.jpg" alt=" Graphic Design Services" description=" Graphic Design Services">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 pt-5">
                    <a href="logo-design.php">
                        <div class="card">
                            <img src="images/Logo-Design-Banner.webp" class="card-img-top" alt=" Graphic Design" description=" Graphic Design">
                ...
                <div class="col-md-3 pt-5">
                    <a href="t-shirt-design.php">
                        <div class="card hover-zoom">
                            <img src="images/T-Shirt-Design-Banner.jpg" class="card-img-top" alt=" Graphic Design" description=" Graphic Design">
                            <div class="card-body text-center">
                ...
                <div class="col-md-3 pt-5">
                    <a href="banner-design.php">
                        <div class="card">
                            <img src="images/Banner-design-image.jpg" class="card-img-top" alt=" Graphic Design" description=" Graphic Design">
                            <div class="card-body text-center">
                ...
                <div class="col-md-3 pt-5">
                    <a href="#">
                        <div class="card">
                            <img src="images/Illustrator-Art-Work-banner.jpg" class="card-img-top" alt=" Graphic Design" description=" Graphic Design">
                            <div class="card-body text-center">
    ...
    <section class=" graphicdesigns_content" style="background: var(--bg-secondary-color) !important;">
        <div class="container">
            <div class="row">
                <div class="newudcode pb-3"><h5>Henceforth, the Philippines Photo Editor website designers provide many multitudes of graphics designs such are:</h5></div>

                <div>
                    <p>Even so, the Philippines Photo Editor website is created too rounded with perfect shape, color, textures, with tools. Similarly, Our website’s Graphics designers established the whole Graphics Design service through the latest versions of 2022 Photoshop 23.0 versions Adobe Photoshop, Adobe Illustrator, and Adobe In-design. Clipping Path, Photo Retouching, Raster to Vector Conversion, Image Masking, Shadow Masking, Photo Restoration, Crop Resizing, Ghost Mannequins Effect, Image Manipulation, Background Remove, Photo Background Remove, Image Retouching Glomar and Weeding, Color Correction, E-commerce Photo Editing, Real State Photo Editing, Jewelry Retouch, Banner Design, Logo Design, T-shirt, etc.</p>
                    <p>Firstly, for Graphic Designs Service, the Philippines Photo Editor never sets any limits. Secondly, you can ask for a logo, banner, and t-shirt that you will get in here. Thirdly, image editing, manipulation, vector, and clipping paths are also great services we are providing. Fourthly, wedding photo editing, eCommerce, or any business or personal-related image you can edit. Finally, all the services related to graphic design you can grab from us at a bulk price. So, will you think longer about purchasing a service? Moreover, for our consumers, we have a huge collection of free samples. </p>
                </div>
            </div>
        </div>
    </section>
