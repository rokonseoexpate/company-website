        ...
        <div class="container">
            <div class="row">
                <div class="ptc_txt">
                    ...
                    <p class=" pt-4">In addition to creating a stress-free and sustainable IT environment, <a href="index.php" class="text-success">SEO Expate</a> Bangladesh Ltd. produces outcomes that help our clients stay ahead of the competition. By utilizing the newest and most widely used technologies, our IT specialists continuously deliver user-centric IT solutions that are customized to the needs of the business. We have been assisting clients all over the world to boost engagement, sales, and conversions for more than ten years. Take a peek at the reliable numbers!</p>
                </div>
    ...
    <section class="Our_Departments core_services">
        <div class="container">
            <div class="row">
                ...
                <p class="text-light pb-4" style="text-align: left;"><a href="index.php" class="text-success">SEO Expate</a> delivers IT services and tech solutions and provides higher value to clients. Our service areas are Software Development, <a href="app-development.php" class="text-success">Mobile App Development</a>, <a href="digital-marketing.php" class="text-success">Digital Marketing</a>, <a href="graphic-design.php" class="text-success">Graphics Design</a>, <a href="content-writing.php" class="text-success">Content Writing</a>, and many more. Also, we have a freelancing training program that helps thousands of youth to build their career.</p>
                <div class="col-md-3">
                    <a href="web-development.php"><img src="images/core-servicr.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Web Development</h5>
                </div>
                <div class="col-md-3">
                    <a href="software-development.php"><img src="images/core-servicerter.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Software Development</h5>
                </div>
                <div class="col-md-3">
                    <a href="app-development.php"><img src="images/core-service-areaer.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Mobile App Development</h5>
                </div>
                <div class="col-md-3">
                    <a href="domain-hosting.php"><img src="images/core-servicer.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Domain & Hosting</h5>
                </div>
            </div>
            <div class="row pt-3">
                <div class="col-md-3">
                    <a href="photo-editor.php"><img src="images/iot-expertiser.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Graphic Design</h5>
                </div>
                <div class="col-md-3">
                    <a href="digital-marketing.php"><img src="images/core-service.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">Digital Marketing</h5>
                </div>
                <div class="col-md-3">
                    <a href="seo-service.php"><img src="images/core-service-areater.png" alt=" seo expate" description=" seo expate"></a>
                    <h5 class="text-light pt-3">SEO</h5>
                </div>
                <div class="col-md-3">
                    <a href="content-writing.php"><img src="images/core-service-arear.png" alt=" seo expate" description=" seo expate"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="Core_Values_txt pb-5" >
                    ...
                    <p><a href="index.php" class="text-success">SEO Expate</a> is one of the fastest-growing companies in the country. Besides, at the heart of our success lies a determined commitment to our core values. Thus, these values guide us to tackle challenges in every sector to deliver exceptional results for our clients.</p>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt">
                        ...
                        <p><a href="index.php" class="text-success">SEO Expate</a> is obsessed with bringing success to clients. In addition, we always put our clients first. Client needs are our 1st priority and we do everything to provide a better experience to the clients. Whether it's making a sale, marketing our services, or providing ongoing support, our main goal is to ensure our clients have a smooth and happy experience every step of the way.</p>
                    </div>
                </div>
                <div class="col-md-6">
