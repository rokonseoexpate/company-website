...
<body>
					...
					<div class="d-flex gap-3 resflex">
						<div class="" style="z-index:500;">
							<div class="top-body-button pt-3">
								<a type="button" href="web_development.html">Web development</a>
							</div>
						</div>		
						<div class="" style="z-index:500;">
							<div class="top-body-button pt-3">
								<a type="button" href="app_development.html">App Development</a>
							</div>
						</div>		
						<div class="" style="z-index:500;">
							<div class="top-body-button pt-3">
    ...
    <section class="top_body_project_countdown">
	    <div class="container">
	        <div class="row">
	            <div class="ptc_txt">
					<div class="updatecode text-success" style="margin-bottom: -30px;"><h6>A Short Introduction to Our Approach</h6></div>
	                
	                <h4>Delivering IT Solutions Globally</h4>
	                <p class=" pt-4">In addition to creating a stress-free and sustainable IT environment, <a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. produces outcomes that help our clients stay ahead of the competition. By utilizing the newest and most widely used technologies, our IT specialists continuously deliver user-centric IT solutions that are customized to the needs of the business. We have been assisting clients all over the world to boost engagement, sales, and conversions for more than ten years. Take a peek at the reliable numbers!</p>
	            </div>
		...
		<div class="container">
			<div class="row">
				<div class="Our_Infrustructure_img pt-3">
					<img src="images/infrustructureer-1024x490.jpg" alt=" seo expate" description=" seo expate">
				</div>
			</div>
		</div>
	</section>
	...
	<section class="Our_Departments core_services">
		<div class="container">
			<div class="row">
				<div class="updatecode"><h6 class="pb-3 text-light">Hire Us</h6></div>
				
				<p class="text-light pb-4" style="text-align: left;"><a href="index.html" class="text-success">SEO Expate</a> delivers IT services and tech solutions and provides higher value to clients. Our service areas are Software Development, <a href="app_development.html" class="text-success">Mobile App Development</a>, <a href="digital_marketing.html" class="text-success">Digital Marketing</a>, <a href="graphic_design.html" class="text-success">Graphics Design</a>, <a href="content_writing.html" class="text-success">Content Writing</a>, and many more. Also, we have a freelancing training program that helps thousands of youth to build their career.</p>
				<div class="col-md-3">
					<a href="web_development.html"><img src="images/core-servicr.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Web Development</h5>
				</div>
				<div class="col-md-3">
					<a href="software_development.html"><img src="images/core-servicerter.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Software Development</h5>
				</div>
				<div class="col-md-3">
					<a href="app_development.html"><img src="images/core-service-areaer.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Mobile App Development</h5>
				</div>
				<div class="col-md-3">
					<a href="domain_hosting.html"><img src="images/core-servicer.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Domain & Hosting</h5>
				</div>
			</div>
			<div class="row pt-3">
				<div class="col-md-3">
					<a href="photo_editor.html"><img src="images/iot-expertiser.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Graphic Design</h5>
				</div>
				<div class="col-md-3">
					<a href="digital_marketing.html"><img src="images/core-service.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Digital Marketing</h5>
				</div>
				<div class="col-md-3">
					<a href="seo_service.html"><img src="images/core-service-areater.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">SEO</h5>
				</div>
				<div class="col-md-3">
					<a href="content_writing.html"><img src="images/core-service-arear.png" alt=" seo expate" description=" seo expate"></a>
					<h5 class="text-light pt-3">Content Writing</h5>
				</div>
			</div>
			<div class="top-body-button pt-5">
				<a type="button" href="services.html">See More Services</a>
			</div>
		</div>
	</section>
	...
	<section class="Our_Departments Our_Engagement">
		<div class="container">
			<div class="row">
				<div class="updatecode"><h6 class="pb-3 ">Our Engagement Models</h6></div>
				...
				<div class="col-md-4">
					<img src="images/Manage Every Part of Your IT Operation.jpg" alt=" seo expate" description=" seo expate">
				...
				<div class="col-md-4">
					<img src="images/Having A Proactive and Proficient Team.jpg" alt=" seo expate" description=" seo expate">
			...
			<div class="row pt-3">
				<div class="col-md-6">
					<img src="images/Speeding Up Your Business's Success.JPG" alt=" seo expate" description=" seo expate">
	...
	<section class="top-slider-part">		
		<div class="container ">
		    <div class="row">
				<div class="updatecode"><h6 class="pb-3 "><span class="text-success">Our </span>Reliable Customers and Associates</h6></div>
		    	<p><a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. takes great pride in collaborating with businesses, firms, service providers, corporations, government departments, and other organizations as a top information technology company.  
				Here take a look at some of the top companies and institutions that <a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. has already worked with.</p>
					...
					<div id="carouselExampleDark" class="carousel carousel-dark slide">
					  ...
					  <div class="carousel-inner pb-5">
					    <div class="carousel-item active" data-bs-interval="10000">
					      <img src="images/slide1.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
					    </div>
					    <div class="carousel-item" data-bs-interval="2000">
					      <img src="images/slide2.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
					    </div>
					    <div class="carousel-item">
					      <img src="images/slide3.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
					    </div>
					    <div class="carousel-item">
					      <img src="images/slide4.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
					    </div>
					  </div>
        ...
        <div class="container">
            <div class="row">
                <div class="Core_Values_txt pb-5" >
					<div class="newupdcode"><h5 class="pb-3 fs-1">We’re Driven by <span class="text-success">our Core Values </span></h5></div>
                    <p><a href="index.html" class="text-success">SEO Expate</a> is one of the fastest-growing companies in the country. Besides, at the heart of our success lies a determined commitment to our core values. Thus, these values guide us to tackle challenges in every sector to deliver exceptional results for our clients.</p>                   
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt">
                        <div class="newudcode"><h5 class="">Customer Obsession:</h5></div>
                        <h6 class=" pb-3">Commitment, Quality, Success</h6>
                        <p><a href="index.html" class="text-success">SEO Expate</a> is obsessed with bringing success to clients. In addition, we always put our clients first. Client needs are our 1st priority and we do everything to provide a better experience to the clients. Whether it's making a sale, marketing our services, or providing ongoing support, our main goal is to ensure our clients have a smooth and happy experience every step of the way.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3 ">
                        <img src="images/slide4.jpg" alt=" seo expate" description=" seo expate" class="img-thumbnail">
                    </div>
                </div>
            </div>
            <hr>
            <div class="row pt-4">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/seven.jpg" alt=" seo expate" description=" seo expate" class="img-thumbnail">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt">
						<div class="newudcode"><h5 class="">Eagerness to Invent:</h5></div>
                        <h6 class="pb-3">Courage, Innovation, Growth</h6>
                        <p>We believe in going beyond simply listening to our clients. Also, We are a team of passionate inventors, constantly pushing the boundaries to develop groundbreaking solutions that empower your success. Besides, the innovations we create have a ripple effect, benefiting not only your business but also your customers and the communities you serve. So, you can partner with <a href="index.html" class="text-success">SEO Expate</a>, and let's co-create the future together. Therefore, we will boost our inventive spirit, and convert your ideas into real-world success. </p>
                    </div>
                </div>                
            </div>
            <hr>
            ...
            <div class="row pt-4">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/slide6.jpg" alt=" seo expate" description=" seo expate" class="img-thumbnail">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt">
						<div class="newudcode"><h5 class="">Operation Excellence:</h5></div>
			...
			<div class="row">
				...
				<div class="col-md-6 pb-5">
					<div class="contact_form_icons">
						...
						<div class="row">
							<div class="col-md-4">
								<img src="images/unicef-client-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/usaid-org-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/undp-org-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/unwomen-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/who-org-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/fao-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>							
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/sands-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/murka-games-limited-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/safe-guard-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/atec-global-client-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/bbc-action-media-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/sesame-workshop-bangladesh-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/ifrc-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/crazylabs-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/voodoo-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/swiss-marketing-systems-gmbh-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/princetech-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/fhi360-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/financial-fondue-gmbh-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/playmania-israeli-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/pinklime-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/mcafee-enterprises-inc-entertainment-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/kuato-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/plan-international-bangladesh-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/cog-media-agency-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/frobolous-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/capital-numbers-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
						<div class="row margintop">
							<div class="col-md-4">
								<img src="images/a2i-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/ict-division-govt-logo.png" alt=" seo expate" description=" seo expate">
							</div>
							<div class="col-md-4">
								<img src="images/robi-axiata-company-logo.png" alt=" seo expate" description=" seo expate">
							</div>
						</div>
					</div>
				</div>
