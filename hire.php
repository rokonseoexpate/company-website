            ...
            <div class="row">
                ...
                <div class="col-md-8"  style="z-index:500;">
                    <div class="d-flex gap-3 resflex">
                        ...
                        <div class="" style="z-index:500;">
                            <div class="top-body-button pt-3">
                                <a type="button" href="app-development">App Development</a>
                            </div>
                        </div>
                        <div class="" style="z-index:500;">
                            <div class="top-body-button pt-3">
                                <a type="button" href="contact">Let's Talk 😄</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="ptc_txt">
                    ...
                    <p class=" pt-4">In addition to creating a stress-free and sustainable IT environment, <a href="/" class="text-success">SEO Expate</a> Bangladesh Ltd. produces outcomes that help our clients stay ahead of the competition. By utilizing the newest and most widely used technologies, our IT specialists continuously deliver user-centric IT solutions that are customized to the needs of the business. We have been assisting clients all over the world to boost engagement, sales, and conversions for more than ten years. Take a peek at the reliable numbers!</p>
                </div>
    ...
    <section class="Our_Departments core_services">
        <div class="container">
            <div class="row">
                ...
                <p class="text-light pb-4" style="text-align: left;"><a href="/" class="text-success">SEO Expate</a> delivers IT services and tech solutions and provides higher value to clients. Our service areas are Software Development, <a href="app-development.php" class="text-success">Mobile App Development</a>, <a href="digital-marketing.php" class="text-success">Digital Marketing</a>, <a href="graphic-design.php" class="text-success">Graphics Design</a>, <a href="content-writing.php" class="text-success">Content Writing</a>, and many more. Also, we have a freelancing training program that helps thousands of youth to build their career.</p>
                <div class="col-md-3">
            ...
            <div class="row pt-3">
                <div class="col-md-3">
                    <a href="photo-editor.php"><img src="frontend/images/iot-expertiser.png" alt=" seo expate" description=" seo expate"></a>
    ...
    <section class="top-slider-part">
        <div class="container ">
            <div class="row">
                ...
                <p><a href="/" class="text-success">SEO Expate</a> Bangladesh Ltd. takes great pride in collaborating with businesses, firms, service providers, corporations, government departments, and other organizations as a top information technology company.
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide">
                        ...
                        <div class="carousel-inner pb-5">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="frontend/images/slide1.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img src="frontend/images/slide2.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
                            </div>
                            <div class="carousel-item">
                                <img src="frontend/images/slide3.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
                            </div>
                            <div class="carousel-item">
                                <img src="frontend/images/slide4.png" class="d-block w-100" alt=" seo expate" description=" seo expate">
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="Core_Values_txt pb-5" >
                    ...
                    <p><a href="/" class="text-success">SEO Expate</a> is one of the fastest-growing companies in the country. Besides, at the heart of our success lies a determined commitment to our core values. Thus, these values guide us to tackle challenges in every sector to deliver exceptional results for our clients.</p>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt">
                        ...
                        <p><a href="/" class="text-success">SEO Expate</a> is obsessed with bringing success to clients. In addition, we always put our clients first. Client needs are our 1st priority and we do everything to provide a better experience to the clients. Whether it's making a sale, marketing our services, or providing ongoing support, our main goal is to ensure our clients have a smooth and happy experience every step of the way.</p>
                    </div>
                </div>
                <div class="col-md-6">
