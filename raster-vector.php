...
<head>
	...
	<title>Raster to Vector Conversion</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Raster-to-Vector-Conversion-Service-1.webp" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Raster-to-Vector-Conversion-Service-3.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Raster-to-Vector-Conversion-Service-4.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Raster-to-Vector-Conversion-Service-2.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Raster-to-Vector-Conversion-Service-5.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Raster-to-Vector-Conversion-Service-6.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Raster-to-Vector-Conversion-Service-1.webp" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion">
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="pb-5 border-bottom border-success border-2">
                    <p>Our <a href="index.html" class="text-success">company</a> specializes in a unique raster to vector conversion service. It caters to a wide range of clients seeking clear and precise graphics for their projects. Whether you're a designer, architect, or engineer, our service transforms raster images into scalable vector graphics effortlessly. We use advanced technology and expert techniques for this service. We ensure that every detail from the original image is accurately preserved in the vector format. This means clearer lines, smoother curves, and better overall quality for your designs.</p> 
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Raster-to-Vector-Conversion-Service.png" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion"  class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
