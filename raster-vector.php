		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src=frontend/"images/Raster-to-Vector-Conversion-Service-1.webp" alt=" Raster to Vector Conversion" description=" Raster to Vector Conversion" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
