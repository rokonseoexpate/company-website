...
<body>
		    	...
		    	<div class="col-md-7 ecomresp" style="z-index:500;">
					...
					<div class="row">
						...
						<div class="col-md-2 ecomrespons">
							<img src="images/google-seo-proposal-audit.png.webp" alt="Magento SEO & Search Marketing Services" description=" Magento SEO & Search Marketing Services" class="img-fluid" >
						</div>
					</div>	
				</div>
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500;" >
					<img src="images/magento_seo_services.png" alt="Magento SEO & Search Marketing Services" description=" Magento SEO & Search Marketing Services" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
	...
	<section class=" graphicdesigns_content">
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-md-6">
                	<div class="clip_img">
						<img src="images/mqdefault.jpg" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
                </div>
                <div class="col-md-6 pt-5">
                	<div class="clip_img">
						<img src="images/1684439247661.jpg" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
                </div>
                <div class="col-md-6 pt-5">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/amasty.png" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="container shadow py-5 px-5 " style="border-left:15px solid #F4B400;">
            <div class="row ">
            	<div class="col-12">
	                ...
	                <div><img src="images/648142ed68d6c27c90b7adcd_Keyword research.webp" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail"></div>
	...
	<section class="cliping_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/front2.png" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
				</div>
				<div class="col-md-6" style="z-index:500;">
	...
	<section class="cliping_service">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/magento-2-default-title-and-description.jpg" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/46524ee074c617253b34f5d3304e6fddc1737113-1200x529.png" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
				</div>
				<div class="col-md-6" style="z-index:500;">
	...
	<section class="cliping_service">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/image-optimization-guide-alt-text-in-wordpress-example.png" alt="Magento SEO" description=" Magento SEO" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="Magento SEO" description=" Magento SEO">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="Magento SEO" description=" Magento SEO" width="100%">
                </div>
            </div>
        </div>
    </section>
