...
<head>
	...
	<title>Real Estate Photo Editing</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Real-Estate-Photo-Editing-5.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Real-Estate-Photo-Editing-2.webp" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Real-Estate-Photo-Editing-3.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Real-Estate-Photo-Editing-4.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Real-Estate-Photo-Editing-5.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Real-Estate-Photo-Editing-6.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Real-Estate-Photo-Editing-1.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Real-Estate-Photo-Editing.png" alt=" Real Estate Photo Editing" description=" Real Estate Photo Editing" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
