            ...
            <div class="row">
                <div class="col-md-7 ecomresp" style="z-index:500; ">
                    <div class="top_body_txt_part">
                        ...
                        <p style="margin-top: -15px; text-align: justify;">Microsoft Word is used in correspondence, book writing, notice giving, document print, basic design, document, questionnaire, print, official note, official letter, various <a href="contact.php" class="text-success">contract</a> documents, table box, personal notes, various project documents, resume and many more. can work Collecting various important information etc.</p>
                    </div>
                    <div class="row">
