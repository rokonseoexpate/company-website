	...
	<div class="container shadow px-5 py-5">
		<div class="row">
			<div class="col-12 pb-5">
				<div class="newudcode">
					<h6 class="text-center">Why learn this Microsoft Office Specialist course?</h6>
				</div>
...
<section class=" graphicdesigns_content ptunset sptunset">
	<div class="container shadow px-5 py-5">
		<div class="row">
			<div class="col-12 pb-5">
				<div class="newudcode">
					<h6 class="text-center">What will be taught in this course: Microsoft Office Specialist</h6>
				</div>
				<div class="border-bottom border-3 border-success">
				</div>
			</div>
