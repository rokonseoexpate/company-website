...
<head>
	...
	<title>Microsoft Office Course</title>
...
<body>
		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						<h1 class="marginbottom" style="font-size: 45px; line-height: 55px;">Microsoft Office Specialist (MOS)</h1>	
						<p style="margin-top: -15px; text-align: justify;">Microsoft Word is used in correspondence, book writing, notice giving, document print, basic design, document, questionnaire, print, official note, official letter, various <a href="contact.html" class="text-success">contract</a> documents, table box, personal notes, various project documents, resume and many more. can work Collecting various important information etc.</p>																						
					</div>
					<div class="row">
				...
				<div class="col-md-5 m-auto pt-5 ecomrespp" style="z-index:500; ">
					<img src="images/mos-excel-core-eng.png" alt="Microsoft Office" description=" Microsoft Office" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
				...
				<div class="col-12" style="z-index:500;">
					<div class="top_about_us_txt" style="z-index:500;">
						...
						<ol class="breadcrumb breadcumb_gph">
							...
							<li class="breadcrumb-item active text-light" aria-current="page">Microsoft Office</li>
						</ol>
						</nav>
					</div>				
				</div>
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
            	<div class="col-12 pb-5">
                	<div class="newudcode"><h6 class="text-center">Why learn this Microsoft Office Specialist course?</h6></div>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
                	<p>1. Those who are already graduate and want to get job in basic computer industry.</p>
                	<p>2. Want to start career in various marketing agencies, IT companies.</p>
                	<p>3. It is natural to get a job if you learn to work well.</p>
                	<p>4. You will get improvement in work life and take a step ahead.</p>
                	<p>5. You can also do your own work easily and beautifully.</p>
                	<p>6. Work speed will increase. The work will be of professional level.</p>
                	<p>7. Can survive in the digital competition of the modern era.</p>
                </div>
                <div class="col-12">
	...
	<!--================================editor_texts section start here=======================-->
	<section class=" graphicdesigns_content ptunset sptunset">
        <div class="container shadow px-5 py-5">
            <div class="row">
            	<div class="col-12 pb-5">
					<div class="newudcode"><h6 class="text-center">What will be taught in this course: Microsoft Office Specialist</h6></div>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
                	<p>1. <strong class="text-success">Microsoft Word</strong> is used in correspondence, book writing, notice giving, document print, basic design, document, questionnaire, print, official note, official letter, various contract documents, table box, personal notes, various project documents, resume and many more. can work Collecting various important information etc.</p>
                	<p>2. With <strong class="text-success">Microsoft Excel</strong> you can easily collect their various data. Again, you can easily work by applying any organization's salary, result, electricity bill, profit and loss, bank loan account, personal account, organization account, etc.</p>
                	<p>3. Creating office or college presentations in <strong class="text-success">Microsoft PowerPoint</strong>, creating your resume in the form of slides, creating documentaries of a place or country, even videos can be created with Microsoft PowerPoint.</p>
                </div>
            </div>
        </div>
    </section>
	...
	<section class=" graphicdesigns_content ptunset" style="padding-top: unset;">
        <div class="container shadow px-5 py-5">
            <div class="row">
            	<div class="col-12 pb-5">
					<div class="newudcode"><h6 class="text-center">Why learn to work with us?</h6></div>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
                	...
                	<p>9. Arrangement of job placement and internship.</p>
                	<p>10. Interview and job preparation is done.</p>
                </div>
            </div>
        </div>
    </section>
	...
	<section class=" graphicdesigns_content ptunset" style="padding-top: unset;">
        <div class="container shadow px-5 py-5 border-start border-5 border-warning border-0">
            <div class="row">
            	<div class="col-12 pb-5">
					<div class="newudcode"><h6 class="text-center">Additional facilities</h6></div>
	                <div class="border-bottom border-3 border-success">
	                </div>
                </div>
                <div class="col-12">
