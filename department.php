        ...
        <div class="row">
            <div class="col-12" style="z-index:500; ">
                <div class="top_body_txt_part">
                    ...
                    <p style="margin-top: -35px; text-align: justify;">Stay connected with SEO Expate Bangladesh Ltd.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="card card-block shadow">
                                <img src="<?php echo 'uploads/' . basename($emp['image']); ?>"
                                    alt="<?php echo $emp['alt_tag']; ?>"
                                    description="<?php echo $emp['alt_description'] ?>" class="img-thumbnail">
                                <div class="card-body">
