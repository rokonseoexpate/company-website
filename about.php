...
<section class="top-body top_about_us" style="background-image: url(images/2.jpg); background-repeat: no-repeat;  background-position: center center; background-size: cover;  margin-top: 60px; ">		
		<div class="container ">
		    <div class="row">
			...
			<div class="row">
				<div class="Providing_Solutions_txt">
					...
					<div class="top-body-button pt-3">
						<a type="button" href="#">Let's Talk 😄</a>
					</div>
				</div>
			</div>
		</div>
                  ...
                  <div class=" container">
                    <div class="row">
                      <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card" style="background: #00000091;">
                          <div class="bg-image hover-zoom ">
                            <img src="frontend/images/Blod Donet.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                            data-mdb-ripple-color="light">
                            <img src="frontend/images/Ballo Bibaho.JPG"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/Atim and gorib sikkhtaire majhe taka bitoron.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/Khela Samgoggri Bitoron.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                            data-mdb-ripple-color="light">
                            <img src="frontend/images/Taka Bitoron.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/Seop-Expate- blanket-distribution-thumbnail.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                  ...
                  <div class=" container">
                    <div class="row">
                      <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card" style="background: #00000091;">
                          <div class="bg-image hover-zoom ">
                            <img src="frontend/images/06.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                            data-mdb-ripple-color="light">
                            <img src="frontend/images/05.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/04.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/03.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                            data-mdb-ripple-color="light">
                            <img src="frontend/images/02.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
                      ...
                      <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card"  style="background: #00000091;">
                          <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                            <img src="frontend/images/01.jpg"
                              class="w-100" />
                            <a href="#!">
                              <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100">
        ...
        <div class="container">
            <div class="row">
                <div class="Core_Values_txt pb-5" >
                    <h3>We’re Driven by <span>our Core Values</span></h3>
