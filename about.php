		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 pb-5">
					<div class="card" >
				      	<img src="<?php echo 'uploads/' . basename($row['image']); ?>" class="card-img-top" alt="<?php echo $row['name'] ?>" description="<?php echo $row['name'] ?>, <?php echo $row['address'] ?>">
						<div class="card-body">
		...
		<div class="container">
			<div class="row">
				...
				foreach ($result as $department) {
					...
					?>
				<div class="col-md-3">
					<a href="department.php"><img src="<?php echo $newImagePath ?>" alt="<?php echo $department['name'] ?>" description="<?php echo $department['name'] ?>"></a>
								...
								<div class="col-lg-4 col-md-12 mb-4">
									<div class="card" style="background: #00000091;">
										<div class="bg-image hover-zoom ">
											<img src="<?php echo $newImagePath ?>" class="w-100" alt="<?php echo $blog['title'] ?>" description="<?php echo strip_tags($blog['short_description']) ?>" />
											<a href="#!">
												<div class="mask">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card" style="background: #00000091;">
                          ...
                          <div class="card-body">
                            <a href="blog_details.html" class="text-reset">
		...
		<div class="container">
			<div class="row">
				<div class="top_featured_txt">
					...
					<p>SEO Expate Bangladesh Ltd is a national powerhouse and global player in IT <a href="services.html" class="text-success"> services</a> and technology solutions. Our innovative works have been featured in multiple TV channels, Newspapers, Magazines, and other popular platforms. This recognition boosts our passion to keep innovating.</p>
				</div>
				<div class="slider pt-5">
		            <div class="owl-carousel">
		               <div class="slider-card">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="top-body-button pt-5 text-center">
					<a type="button" href="about.html">See How We Work</a>
				</div>
            </div>
        </div>
    </section>
