...
<head>
	...
	<title>PPC Lead Generation  </title>
...
<body>
		    	...
		    	<div class="col-md-7" style="z-index:500; ">
					...
					<div class="row">
						<div class="col-md-7 pt-2">
							<div class=" border-bottom border-3 border-success pb-3"><a href="contact.html" style="color: #F4B400;" class="fs-5 fw-bold ">Talk with our expert PPC Lead Generation </a></div>
						</div>
						<div class="col-md-2">
							<img src="images/google-seo-proposal-audit.png.webp" alt="PPC Lead Generation" description=" PPC Lead Generation" class="img-fluid" >
						</div>
					</div>	
				</div>
				<div class="col-md-5 m-auto" style="z-index:500;" >
					<img src="images/types-of-lead-generation.png" alt="PPC Lead Generation" description=" PPC Lead Generation" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/seo_reporting_dashboard_data_studio.webp" alt="PPC Lead Generation" description=" PPC Lead Generation" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="PPC Lead Generation" description=" PPC Lead Generation">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="PPC Lead Generation" description=" PPC Lead Generation" width="100%">
                </div>
            </div>
        </div>
    </section>
