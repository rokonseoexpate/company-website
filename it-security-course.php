...
<body>
		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						<h1 class="marginbottom" style="font-size: 45px; line-height: 55px;">IT Service & Business management Specialist</h1>																						
					</div>
					<div class="row">
				...
				<div class="col-md-5 m-auto pt-5 ecomrespp" style="z-index:500; ">
					<img src="images/images (2).jpg" alt="IT Service & Business management" description=" IT Service & Business management" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
				...
				<div class="col-12" style="z-index:500;">
					<div class="top_about_us_txt" style="z-index:500;">
						...
						<ol class="breadcrumb breadcumb_gph">
							...
							<li class="breadcrumb-item active text-light" aria-current="page">IT Service</li>
						</ol>
						</nav>
					</div>				
				</div>
	...
	<div class="seopackages contentpricing">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">IT Security & AUDIT ZONE</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>CEH (Certified Ethical Hacker)</p></span></td>
                ...
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>ECSA (EC-Council Certified Security Analyst)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>CHFI (Computer Hacking Forensic Investigator)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>CCISO (Certified Chief Information Security Officer)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>CISM (Certified Information Security Manager)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	CISSP (Certified Information Systems Security Professional)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Offensive Security Certified Professional-OSCP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>CISA (Certified Information Systems Auditor)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">IT Service & Business management</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>ITIL Foundation</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>ITIL Service Operation</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>ITIL Service Strategy</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>ITIL Transition</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Project Management Professional</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Program Management Professional PgMP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>PMI-ACP  PMI Agile Certified Practitioner</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>PMI-PBA  PMI Professional in Business Analysis</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	PMI-RMP  PMI Risk Management Professional</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Prince 2 Practioner</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Prince 2 Foundation</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Agile</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Microsoft project server 2010 , configureing, Manageing Projects</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	COBIT Control Objectives for Information and Related Technologies</p></span></td>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="IT Service & Business management" description=" IT Service & Business management">
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                 	<img src="images/Payment-method-banner-image-1024x73.webp" alt="IT Service & Business management" description=" IT Service & Business management" width="100%">
                </div>
            </div>
        </div>
    </section>
