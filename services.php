...
<!--================================Header section end here=======================-->
	...
	<!--================================MobileApp section start here=======================-->
	<section class="MobileApp">
		<div class="container">
			<div class="row">
				<h2 class="text-center fw-bold fs-1 pt-5 pb-5">Mobile App Development</h2>
				<div><img src="frontend/images/Mobile-App-Development-Services.jpg" alt=" Mobile App Development" description="Mobile App Development" class="img-thumbnail"></div>
				<div class="col-md-6">
	...
	<!--================================MobileApp section end here=======================-->

	<!--================================MobileApp section start here=======================-->
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Internet of Things - IoT</h6>
				<div><img src="frontend/images/iot.jpg" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
	...
	<section class="MobileApp">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Blockchain Development</h6>
				<div><img src="frontend/images/Featured-Image-1280x595.webp" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Game Development</h6>
				<div><img src="frontend/images/1_7jCMzHmTj0fuGH0OR6p5dA.png" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
	...
	<section class="MobileApp">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">AR / VR / MR Solutions</h6>
				<div><img src="frontend/images/ar-vr-mr-featured-image.webp" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Quality Engineering</h6>
				<div><img src="frontend/images/1_7jCMzHmTj0fuGH0OR6p5dA.png" alt="image" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Research and Development</h6>
				<div><img src="frontend/images/AdobeStock_509058256.jpeg" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
							<div><i class="fa-solid fa-charging-station" alt=" Software Development" description="Software Development"></i></div>
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Outsourcing</h6>
				<div><img src="frontend/images/633675d0879cf71a7209c5f8_jpeg-optimizer-Global-outsourcing.webp" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
							<div><i class="fa-solid fa-charging-station" alt=" Software Development" description="Software Development"></i></div>
	...
	<section class="MobileApp">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Multimedia Content Development</h6>
				<div><img src="frontend/images/unnamed (1).jpg" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Digital Marketing</h6>
				<div><img src="frontend/images/digital-marketing-vs-traditional-marketing-whats-the-difference.webp" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
	...
	<section class="MobileApp">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Automation & Simulation</h6>
				<div><img src="frontend/images/1000_F_449447204_tIf9mp2uSc4DgXN4WmlvXAC4vkEsLssq.jpg" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
	...
	<section class="MobileApp WebDevelopment">
		<div class="container">
			<div class="row">
				<h6 class="text-center fw-bold fs-1 pt-5 pb-5">Capacity Building for IT and ITES</h6>
				<div><img src="frontend/images/capacity.jpg" alt=" Software Development" description="Software Development" class="img-thumbnail"></div>
				<div class="col-md-6">
					<div class="mobileapp_iconlist">
						<div class="d-flex">
