		...
		<div class="container">
			...
			<hr>							
				<div class="col-md-6">					
					...
					<p> <span><i class="fa-solid fa-circle"></i></span>We want to be the most reliable web development <a href="index.php" class="text-success">company</a> in Bangladesh.</p>
				</div>
				<div class="col-md-6">
					  	...
					  	<div class="row mb-5">
						    ...
						    <div class="tab-content" id="myTabContent">
						      	<div id="personal" role="tabpanel" aria-labelledby="personal-tab" class="tab-pane fade px-4 py-5 show active">
						      		<div class="row ">
										<div class="col-md-3 pt-5">
											<a href="https://bn.nordfx.com/">
												<div class="card" >
										      	<img src="frontend/images/safbd.png" class="card-img-top" alt="Web Development " description="Web Development" width="100%">
										      	<div class="card-body">
										...
										<div class="col-md-3 pt-5">
											<a href="http://isp.devseoebd.com/">
												<div class="container">
												    <div class="card" >
												      <img src="frontend/images/isp.png" class="card-img-top" alt="Web Development " description="Web Development" width="100%">
												      <div class="card-body">
										...
										<div class="col-md-3 pt-5">
											<a href="https://amirrecruitingagencysrl.com/">
												<div class="container">
												    <div class="card" >
												      <img src="frontend/images/amirrecruitingagencysrl.png" class="card-img-top" alt="Web Development " description="Web Development" width="100%">
												      <div class="card-body">
										...
										<div class="col-md-3 pt-5">
											<a href="https://constructions.devseoebd.com/">
												<div class="container">
												    <div class="card" >
												      <img src="frontend/images/construction.png" class="card-img-top" alt="Web Development " description="Web Development" width="100%">
												      <div class="card-body ">
									...
									<div class="row ">
										<div class="col-md-3 pt-5">
											<a href="https://ngo.devseoebd.com/">
												<div class="container">
												    <div class="card" >
												      <img src="frontend/images/ngo.png" class="card-img-top" alt="Web Development " description="Web Development" width="100%">
												      <div class="card-body ">
		...
		<div class="container">
			<div class="row">
				<div class="what_you_need_txt ">
					...
					<p>Moreover, we have a complete team consisting of UI/UX designers, web developers, content writers, graphics designers, and <a href="index.php" class="text-success">SEO Expates</a>. For that, we can ensure you a wide range of services from the design to rank on Google. Thus, we created a loyal customer base from all across the globe. </p>
