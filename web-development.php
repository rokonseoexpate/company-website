	...
	<div class="container">
		<div class="row">
			<div class="Our_Branches_txt pb-5">
				<h3>Types of Web Development Services</h3>
				<hr>
			</div>
			<div class="col-md-3">
				<a href="#">
		...
		<div class="row pt-5">
			...
			<div class="col-md-3">
				<a href="#">
					<div class="card">
						<img src="frontend/images/travel-website.jpg" class="card-img-top" alt="Image">
						<div class="card-body">
			...
			<div class="col-md-3">
				<a href="#">
					<div class="card">
						<img src="frontend/images/Customize-website.jpg" class="card-img-top" alt="Image">
						<div class="card-body">
...
<div class="our_mission our_promise we_following">
	<div class="container">
		<div class="row">
			<h3 class="text-center pb-5">We Believe in the Following Factors</h3>
			<hr>
			<div class="col-md-6">
				...
				<p> <span><i class="fa-solid fa-circle"></i></span>Industry automation through software & apps to increase productivity.</p>
				...
				<p> <span><i class="fa-solid fa-circle"></i></span>We want to be the most reliable web development company in Bangladesh.</p>
			</div>
			<div class="col-md-6">
				<img src="frontend/images/slide4.jpg" alt="image" class="img-thumbnail">
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="what_you_need_txt">
				...
				<p>The corporate Website will showcase the brand, products, services, and corporate information to the public. It will serve as a digital existence of your company for the public to learn about the company and engage with its offerings. SEO Expate Bangladesh Ltd is one of the most experienced web development companies to serve corporate clients. </p>
				<h4>News Portal Website:</h4>
				...
				<p>SEO Expate Bangladesh Ltd is one of the most renowned IT companies in Bangladesh. We use advanced web design technology and combine it with your business concepts while designing the site. Besides, we always make the website user-friendly and attractive so the visitor spends more time on the page.</p>
				...
				<p>Moreover, we have a complete team consisting of UI/UX designers, web developers, content writers, graphics designers, and SEO experts. For that, we can ensure you a wide range of services from the design to rank on Google. Thus, we created a loyal customer base from all across the globe. </p>
