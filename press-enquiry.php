		    ...
		    <div class="row">
		    	<div class="col-md-7" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						...
						<p style="margin-top: -15px; text-align: justify;">Stay connected with <a href="index.html" class="text-success">SEO Expate</a> Bangladesh Ltd. PR and Media team for latest information on new technology innovation, latest products and updates. We are changing and bringing digital transformation across the world. Publish news about our digital journey and strategies to build a better future with technology.</p>											
					</div>	
				</div>
				<div class="col-md-5 m-auto" style="z-index:500; ">
					<img src="images/4d25c6bd3f17faaaa9015077d9da28ac.jpg" alt=" PR Resources" description=" PR Resources" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
	...
	<section class=" graphicdesigns_content">
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-12">
                	<p>We help national and international journalists with up-to-date justified resources on  <a href="contact.html" class="text-success">Information</a> and Technology. You will get the exact and accurate technology news from us.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt=" PR Resources" description=" PR Resources">
                    </div>
                </div>
            </div>
        </div>
