            ...
            <div class="row">
            	<div class="col-12 pb-5">
	                ...
	                <div class="border-bottom border-3 border-success">
	                    <p class="text-center">We at <a href="/" class="text-success">SEO Expate</a> have tried-and-true <a href="seo-service.php" class="text-success">SEO</a> techniques to enhance your WordPress website. <br> We'll apply what we've learned from working with previous WordPress clients to you.</p>
	                </div>
                </div>
