		    ...
		    <div class="row">
		    	<div class="col-12" style="z-index:500;">
		    		<div class="top_body_txt_part">
						<h1>Image Masking</h1>		
						<p style="text-align:justify;">Image Masking Service isolates specific elements within an image while maintaining fine details and transparency. It creates a vector path to isolate objects in an image. It allows editing of specific areas in an image. Therefore, this service will be your best option to remove backgrounds, refine edges, or isolate complex subjects. Also, Image masking service is a crucial technique in graphic design and image editing.  It ensures a clean and professional look.  Moreover, it allows you to focus on other aspects of your business while experts handle your service. Indeed, by investing in professional image masking, you can elevate the quality of your visuals.</p>
						<p style="text-align:justify;">In addition, professional image masking services offer a valuable solution for enhancing your visuals with precision. Moreover, it plays a vital role in enhancing the visual appeal of images in various industries. To conclude, you can create captivating images that leave a lasting impression on your audience using this service.</p>						
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12" style="z-index:500;">
					...
					<div class="pb-2 pt-2 text-light"><h4 class="fs-1 fw-bold">Image Masking Service</h4></div>
					<p class="pt-2 text-light" >Image Masking Service is useful in the world of graphic design and photography. However, it involves separating an object from its background, allowing for more precise editing and manipulation of the image. This technique is commonly useful for creating visually stunning effects. Also, this service removes backgrounds, adds new backgrounds, or applies different filters and effects. Also, it utilizes advanced software and techniques to ensure a seamless and accurate result. Carefully outlining the object in the image and applying various masking techniques enhance the overall visual appeal of the image. This service can help you achieve your desired results. To conclude, by incorporating image masking into your design process, you can unlock endless possibilities for your brand.</p>					
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2 pt-2"><h6>What is Image Masking</h6></div>
					<p class="pt-3" >Image masking is used in graphic design and photo editing to hide or reveal certain portions of an image. This process involves creating a mask to show or hide parts of an image selectively. Also, it allows for more precise image editing and manipulation. However, Image masking allows for accurate editing of specific areas within an image. It helps in retaining intricate details in an image. This service offers flexibility in editing different elements separately. This service includes layer masking, soft masking, clipping masking, and complex masking.  </p>															
				</div>
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="frontend/images/1.webp" alt="Image Masking" description=" Image Masking" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
					<p class="" >Moreover, it is useful for enhancing product images by removing backgrounds or adding effects. It will help create appealing product images for online stores. Also, it enhances fashion photography by adjusting colors and backgrounds. In conclusion, image masking is a valuable tool in graphic design and photo editing. It offers precision and versatility in manipulating images for various purposes.</p>
				</div>
			</div>
		</div>
	</section>
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="frontend/images/2.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="frontend/images/4.webp" alt="Image Masking" description=" Image Masking" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="frontend/images/1.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="frontend/images/3.webp" alt="Image Masking" description=" Image Masking">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="frontend/images/5.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="frontend/images/6.webp" alt="Image Masking" description=" Image Masking">
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="frontend/images/Image-Masking-Service.png" alt="Image Masking" description=" Image Masking" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
	    ...
	    <div class="container">
		    <div class="row">
		        <div class="col-md-4 col-sm-6">
		            <div class="pricingTable">
		                <div class="pricing_heading">
		                    <h6 class="title">Basic Image Masking</h6>
		                    <p>We will do basic Image Masking with this package</p>
		        ...
		        <div class="col-md-4 col-sm-6">
		            <div class="pricingTable">
		                <div class="pricing_heading">
		                    <h6 class="title">Medium Image Masking</h6>
		                    <p>Medium type Image Masking</p>
		                    <span class="value">
		                        $7
		                    </span>
		                </div>
		        ...
		        <div class="col-md-4 col-sm-6">
		            <div class="pricingTable">
		                <div class="pricing_heading">
		                    <h6 class="title">Complex Image Masking</h6>
		                    <p>Complex Image Masking service</p>
		                    <span class="value">
		                        $10
		                    </span>
		                </div>
