		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/1.webp" alt="Image Masking" description=" Image Masking" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/2.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/4.webp" alt="Image Masking" description=" Image Masking" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/1.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/3.webp" alt="Image Masking" description=" Image Masking">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/5.webp" alt="Image Masking" description=" Image Masking" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/6.webp" alt="Image Masking" description=" Image Masking">
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Image-Masking-Service.png" alt="Image Masking" description=" Image Masking" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
