...
<body>
	...
	<section class="top-body top_about_us" style="background-image: url(images/awards-and-recognitions-background-bannerr.png); background-repeat: no-repeat;  background-position:center center; background-size: cover; padding-top: 180px !important; padding-bottom: 300px;">		
		<div class="container ">
		    <div class="row">
	...
	<section class="Core_Values technology_company">
        <div class="container">
            <div class="row pb-2">
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3 ">
                        <img src="images/Trade License SEOEBDLTD 23-24.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/Trade License Dhaka.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
            ...
            <div class="row pt-4 pb-2">               
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/TIN Certificate SEO Expate BD Ltd.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>                
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/SEO Expate BD Ltd. BACCO Membership Certificate - 2023.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
            ...
            <div class="row pt-4 pb-2">
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/SEO Exparte BD Ltd-Incorporation.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>                
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/Mushak-2.3 BIN Certificate On 28.DEC.2022.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
            ...
            <div class="row pt-4 pb-2">
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/ISO_27001_2022_SEO Expate Bangladesh Ltd.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>                
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/ISO_9001_2015_SEO Expate Bangladesh Ltd.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
            ...
            <div class="row pt-4 pb-2">
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/I kor Moukhup- SEO Expate BD Ltd.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>                
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/BASIS Certificate SEO Expate Bangladesh Ltd 2024.jpg" alt=" seo expate" description=" seo expate">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
            ...
            <div class="row pt-4 pb-2">
                ...
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/freelancer certificate.png" alt=" seo expate" description=" seo expate">
                    </div>
                </div>                
            </div>
            <hr>
            <div class="row pt-4 pb-2">
                <div class="col-md-6">
                    <div class="Core_Values_img pb-5 pt-3">
                        <img src="images/BFDS- certificate.jpg" alt="image">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="Core_Values_txt newudcode">
