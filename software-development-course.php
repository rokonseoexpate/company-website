...
<body>
		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						<h1 class="marginbottom" style="font-size: 45px; line-height: 55px;">Software Development Specialist</h1>	
						<p style="margin-top: -15px; text-align: justify;">Software development is the process programmers use to build computer programs. The process, also known as the Software Development Life Cycle (SDLC), includes several phases that provide a method for building products that meet technical specifications and user requirements.</p>																						
					</div>
					<div class="row"> 
				...
				<div class="col-md-5 m-auto pt-5 ecomrespp" style="z-index:500; ">
					<img src="images/Software-Development-Business1--1-.jpg" alt="Software Development " description="Software Development" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
	...
	<div class="seopackages contentpricing">
        <div class="container">
        	<h3 class="fs-1 fw-bold pt-5 text-center ptunset">Software Development</h3>
        	<hr>
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Basic Courses</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>	Programming in C#</p></span></td>
                ...
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Programming in HTML5 with JavaScript and CSS3 (MCSD)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	WordPress Theme Customization and Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	E-Commerce Website with OpenCart Theme Customization and Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	E-Commerce Website with Mastering Magneto</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	CIW Web Design Specialist</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	e-Commerce Website specialist</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Professional in Python Programming</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>	Certified Entry-Level Python Programme-PCEP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">24 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>		Certified Entry-Level Python Programme-PCEP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Certified Professional in Python Programming 1</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Certified Professional in Python Programming 2</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	CEPP – Certified Expert in Python Programming</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Microsoft Programming</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                ...
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Essentials of Developing Windows Store Apps Using C#</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Developing ASP.NET MVC Web Applications</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Microsoft Certified: Azure Developer Associate</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Microsoft Dynamics 365: Core Finance and Operations</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>		Microsoft Dynamics 365: Finance and Operations Apps Developer</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">40 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Microsoft Certified: Power Platform Developer Associate</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">JAVA Programming</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>Oracle Certified Associate Java SE 8 Programmer <br> Java SE 8 Programmer I <br> Java SE 8 Programmer II</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">80 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Oracle Certified Professional Java SE 11 Developer <br>(Upgrade from OCP Java 6, 7 & 8) <br>Java SE 11 Developer</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Java EE 7 Application Developer</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">62 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle WebLogic 12c certification <br>Oracle WebLogic Server 12c: Administration <Ibr></Ibr>Oracle WebLogic Server 12c: Advanced Administrator II</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">80 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle SOA Suite 12c Essentials</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">62 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle Business Process Management Suite 12c Essentials</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">80 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">PHP Programming</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>	PHP Fundamentals I – III</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	PHP Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Laravel</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">62 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	CakePHP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">62 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Zend Certified PHP Engineer</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	ReactPHP</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Apps Development Zone</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>	Flutter Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Android Developer Fundamentals</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>		Advanced Android Development</p></span></td>
                ...
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>OS 11 Fundamentals</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">48 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Advanced iOS Apps Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">42 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<!--================================editor_texts section start here=======================-->
	<div class="seopackages contentpricing ptunset">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Oracle DATABASE Administrator ZONE</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>	Oracle DATABASE Administrator ZONE</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>		Oracle Certified Associate (OCA)</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle Database 12c Administration</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Oracle Database Administration I</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle Database Administration II</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle Database 12c: RAC and Grid Infrastructure Administration |</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	Oracle Database 12c Administrator Certified Master</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	MySQL 8.0 Database Developer Oracle Certified Professional</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Oracle Database PL/SQL Developer Certified Professional</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
	...
	<div class="seopackages contentpricing ">
        <div class="container">
        	<h6 class="fs-3 fw-bold pt-5 pb-2 text-success ptunset">Microsoft DATABASE Administrator ZONE</h6>
        	<hr>
          <div class="pricing-table table-responsive">
            <table class="table border shadow ">
              <!-- Heading -->
              ...
              <tbody class="border-top border-0 border-white border-bottom border-3">
                <tr>
                  <td class="border-end border-0 border-success border-bottom border-1 border-left"><span class="ptable-title"><p>MCSA: SQL 2016 Database Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Querying Data with Transact-SQL</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Developing SQL Databases</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs	</td>
                  <td class=" border-0 border-end border-success border-bottom border-1"> Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>MCSA: SQL 2016 Database Administration</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Administering a SQL Database Infrastructure</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Provisioning SQL Databases</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>	MCSA: SQL 2016 BI Development</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Implementing a Data Warehouse using SQL</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
                <tr>
                  <td class=" border-0 border-end border-success border-bottom border-1"><span class="ptable-title"><p>Developing SQL Data Models</p></span></td>
                  <td class=" border-0 border-end border-success border-bottom border-1">72 hrs</td>
                  <td class=" border-0 border-end border-success border-bottom border-1">Details</td>
                </tr>
              </tbody>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="Get In Touch " description="Get In Touch">
                    </div>
                </div>
            </div>
        </div>
