		    	...
		    	<div class="col-md-7 ecomresp" style="z-index:500;">
					...
					<div class="row">
						...
						<div class="col-md-2 ecomrespons">
							<img src="images/google-seo-proposal-audit.png.webp" alt="Website Search Marketing " description="Website Search Marketing" class="img-fluid" >
						</div>
					</div>	
				</div>
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500;" >
					<img src="images/seo-serviceS-patna.png" alt="Website Search Marketing " description="Website Search Marketing" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6" style="z-index:500;">
					<div class="cliping_service_txt pb-2"><h6>About Volusion SEO Service. </h6></div>
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/0_Q5ErShpWJcDA-RdO.jpg" alt="Volusion SEO Service " description="Volusion SEO Service" class="img-thumbnail">
					</div>
				</div>
			</div>
		</div>
