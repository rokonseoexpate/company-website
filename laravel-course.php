...
<?php include 'includes/course-nav.php'?>
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
                    <img src="images/laravel-development-company.jpg" alt="Web Development Using Laravel" description=" Web Development Using Laravel"class="img-thumbnail">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="laravel" description=" laravel">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="PAY_MENT" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="PAY_IMG">
                    <img src="images/Payment-method-banner-image-1024x73.webp" alt="laravel" description=" laravel" width="100%">
                </div>
            </div>
        </div>
    </section>
