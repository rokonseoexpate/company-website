...
?>
    ...
    <section class="top-body" style="background-image: url(images/Advanced-technology.jpg); background-repeat: no-repeat;  background-position: center center; background-size: cover;  margin-top: 60px; ">
        <div class="container ">
            <div class="row">
                <div class="col-md-7" style="z-index:500;">
                    <div class="top_body_txt_part">
                        ...
                        <p><a href="index.php" class="text-success">SEO Expate</a> BD Ltd. helps you unlock innovation and navigate the digital future. We empower enterprises to reimagine their business and dominate digital transformation. <a href="certificate.php" class="text-success">Certified</a> for quality and security (ISO 9001 & 27001), we offer cutting-edge IT services and technology solutions. Again, we are proud members of FBCCI, BASIS, BACCO and have all the registered licenses.</p>
                    </div>
                ...
                <div class="col-md-5 col-md-offset-1" style="z-index:500;">
                    <div class="top_body_awards">
                        <img src="images/trophy-of-digital-bangladesh-award-won-by-seoexpate.png" alt="SEO Expate Bangladesh Ltd" description=" SEO Expate Bangladesh Ltd">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="top-slider-part">
        <div class="container ">
            <div class="row">
                <div class="updatecode"><h6><span>Our </span> Reliable Customers and Associates</h6></div>
                ...
                <div class="col-12 pt-5">
                    <div id="carouselExampleDark" class="carousel carousel-dark slide">
                        ...
                        <div class="carousel-inner pb-5">
                            ...
                            <div class="carousel-item">
                                <img src="images/Capturelogo.PNG" class="d-block w-100" alt="Reliable Customers and Associates" description=" Reliable Customers and Associates">
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="ptc_txt">
                    ...
                    <div class="updatecode"><h6 style="padding-bottom: unset;">Delivering IT Solutions Globally</h6></div>
        ...
        <div class="container">
            <div class="row">
                <div class="explore_txt">
                    <div class="updatecode"><h6 style="padding-bottom: unset;">Discover Possibilities</h6></div>
                ...
                <div class="explore_tabs">
                    <div class="container py-5 Roundedtabs">
                        <div class="row mb-5">
                            <div class="p-5 bg-white rounded shadow mb-5 Roundedtabs">
                                <!-- Rounded tabs -->
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div id="personal" role="tabpanel" aria-labelledby="personal-tab" class="tab-pane fade px-4 py-5 show active">
                                        ...
                                        <p class="text-muted mb-0 justifytext">SEO Expate Bangladesh Ltd, a provider of technology solutions, offers advice on how to create solutions for your issues. We help businesses become more inventive and flexible by meeting customer needs and working together to develop ground-breaking goods and services. </p>
                                        <div class="row pt-5">
                                            <div class="col-md-8">
                                                <h6 >Principal Advantages of Our Design and Consultation Services:</h6>
                                                <p class="text-muted mb-0 pt-2"><span><i class="fa-solid fa-circle"></i></span>Utilizing the newest technologies, update or upgrade current systems.</p>
                                            ...
                                            <div class="col-md-4">
                                                <div class="explor_tab_img">
                                                    <img src="images/Advancing Your Business Technology.jpg" alt="technology for your business" description=" technology for your business" class="img-thumbnail">
                                                </div>
                                            </div>
                                            <!-- <div class="top-body-button pt-3 text-center">
                                                <a type="button" href="contact.php">Advising Services</a>
                                            </div> -->
                                        </div>
                                    </div>
                                    <div id="employment" role="tabpanel" aria-labelledby="employment-tab" class="tab-pane fade px-4 py-5">
                                        ...
                                        <div class="row pt-5">
                                            <div class="col-md-8">
                                                <h6 >Principal Advantages of Our Design and Consultation Services: </h6>
                                                <p class="text-muted mb-0 pt-2"><span><i class="fa-solid fa-circle"></i></span>Describe your plans for intelligent automation and digital transformation.</p>
                                                <p class="text-muted mb-0 pt-2"> <span><i class="fa-solid fa-circle"></i></span>Utilizing the newest technologies, update or modernize current systems</p>
                                                <p class="text-muted mb-0 pt-2"><span><i class="fa-solid fa-circle"></i></span>Use design thinking to redefine user experiences</p>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="explor_tab_img">
                                                    <img src="images/Manage Every Part of Your IT Operation.jpg" alt="technology for your business" description=" technology for your business" class="img-thumbnail">
                                                </div>
                                            </div>
                                            <div class="top-body-button pt-3 text-center">
                                    ...
                                    <div id="Services" role="tabpanel" aria-labelledby="Services-tab" class="tab-pane fade px-4 py-5">
                                        ...
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-4">
                                                <div class="explor_tab_img">
                                                    <img src="images/Having A Proactive and Proficient Team.jpg" alt="technology for your business" description=" technology for your business" class="img-thumbnail">
                                                </div>
                                            </div>
                                            <p class="text-muted pt-5 justifytext">The business will benefit from an innovative and holistic IT investment that reduces risk and boosts ROI from our proactive and comprehensive design and consulting services.</p>
                                            <div class="top-body-button pt-3 text-center">
                                                <a type="button" href="services.php"> Services</a>
                                            </div>
                                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="success_stories_slider_txt">
                    <div class="updatecode pb-2"><h6 class="text-light" style="padding-bottom: unset;">Achievement of SEO Expate Bangladesh Ltd.</h6></div>
                ...
                <div class="bbb_main_container pt-5">
                    <div class="bbb_viewed_title_container">
                        <div class="bbb_viewed_nav_container">
                            <div class="bbb_viewed_nav bbb_viewed_prev" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh"><i class="fas fa-chevron-left"></i></div>
                            <div class="bbb_viewed_nav bbb_viewed_next" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh"><i class="fas fa-chevron-right"></i></div>
                        </div>
                    </div>
                    <div class="bbb_viewed_slider_container">
                        <div class="owl-carousel owl-theme bbb_viewed_slider">
                            <div class="owl-item">
                                <div class="card bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/11.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        ...
                                        <a href="award.php" class="">Read Insights <span><i class="fa-solid fa-arrow-right-long"></i></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="card bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/10.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        <h5 class="card-title">Success Story</h5>
                                        <p class="">Seo Expate Bangladesh Ltd.-Success Story</p>
                            ...
                            <div class="owl-item">
                                <div class="card bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/09.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        <h5 class="card-title">Success Story</h5>
                                        <p class="">Seo Expate Bangladesh Ltd.-Success Story</p>
                            ...
                            <div class="owl-item">
                                <div class="card bbb_viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/08.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        <h5 class="card-title">Success Story</h5>
                                        <p class="">Seo Expate Bangladesh Ltd.-Success Story</p>
                            ...
                            <div class="owl-item">
                                <div class="card bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/07.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        <h5 class="card-title">Success Story</h5>
                                        <p class="">Seo Expate Bangladesh Ltd.-Success Story</p>
                            ...
                            <div class="owl-item">
                                <div class="card bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="bbb_viewed_image">
                                        <img src="images/06.png" alt="Achievement of SEO Expate Bangladesh" description=" Achievement of SEO Expate Bangladesh">
                                    </div>
                                    <div class="card-body bbb_viewed_content text-center">
                                        <h5 class="card-title">Success Story</h5>
                                        <p class="">Seo Expate Bangladesh Ltd.-Success Story</p>
        ...
        <div class="container">
            <div class="row">
                <div class="why_work_txt pb-5">
                    <div class="updatecode pb-2"><h6 class="" style="padding-bottom: unset;">Why Work With SEO Expate Bangladesh Ltd.?</h6></div>
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Manage Every Part of Your IT Operation.jpg" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Advancing Your Business Technology.jpg" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                    <div class="work_text pt-3">
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Having A Proactive and Proficient Team.jpg" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                    <div class="work_text pt-3">
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Advanced-technology.jpg" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                    <div class="work_text pt-3">
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Aligning with the Advanced Tech Industry.jpg" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                    <div class="work_text pt-3">
                ...
                <div class="col-md-6">
                    <div class="why_work_img">
                        <img src="images/Speeding Up Your Business's Success.JPG" alt="Work With SEO Expate Bangladesh" description=" Work With SEO Expate Bangladesh">
                    </div>
                    <div class="work_text pt-3">
                    ...
                    <div class="owl-carousel">
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/1.png" alt="Achievements and Recognitions" description=" Achievements and Recognitions" >
                            </div>
                        ...
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/04.png"  alt="Achievements and Recognitions" description=" Achievements and Recognitions">
                            </div>
                        ...
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/06.png"  alt="Achievements and Recognitions" description=" Achievements and Recognitions">
                            </div>
                        ...
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="images/07.png"  alt="Achievements and Recognitions" description=" Achievements and Recognitions" >
                            </div>
    ...
    <section class="top_our_clients">
        <div class="container">
            <div class="row">
                ...
                <div class="slider pt-5 slidecard">
                    <div class="owl-carousel">
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                            ...
                            <div class="p-5 bg-white rounded shadow mb-5">
                                ...
                                <div class="tab-content tabimges" id="myTabContent">
                                    <div id="Mobile" role="tabpanel" aria-labelledby="Mobile-tab" class="tab-pane fade px-4 py-5 show active">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/iOS.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>iOS</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Android.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Android</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Flutter.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Flutter</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Objective-C.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Objective-C</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/C-2.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>C#</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/C-1.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>C++</p>
                                            </div>
                                        </div>
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/swift-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Swift</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/ionic-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Ionic</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/kotlin-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Kotlin</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/augmented-reality-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Augmented Reality</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/virtual-reality-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Virtual Reality</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/react-native-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>React Native</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="Front" role="tabpanel" aria-labelledby="Front-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/AngularJs.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Angular</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/VueJS.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>VueJS</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/HTML.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>HTML</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Bootstrap.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Bootstrap</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/mean-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>MEAN</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/typescript-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>TypeScript</p>
                                            </div>
                                        </div>
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-2">
                                                <img src="images/asp.net-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>ASP.NET</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/CSS.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>CSS</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/ReactJs.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>ReactJs</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/jQuery.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>jQuery </p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/javascript-technology-icon-riseuplabs.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p> JavaScript</p>
                                            </div>
                                            <div class="col-md-1"></div>
                                        </div>
                                    ...
                                    <div id="Back" role="tabpanel" aria-labelledby="Back-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/java-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Java</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Laravel.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Laravel</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/PHP.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>PHP</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/ASP.NET-MVC.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>ASP.NET-MVC</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/django-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Django</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/node.js-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Node.js</p>
                                            </div>
                                        </div>
                                        <div class="row pt-5">
                                            <div class="col-md-1"></div>
                                            <div class="col-md-2">
                                                <img src="images/codeigniter-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Codeigniter</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/koa.js-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Koa.js</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/flask-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Flask</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/express.js-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p> Express.js</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/graphql-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p> GraphQL</p>
                                            </div>
                                            <div class="col-md-1"></div>
                                        </div>
                                    ...
                                    <div id="Database" role="tabpanel" aria-labelledby="Database-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/MySQL.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>MySQL</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Apache.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Apache</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Firebase.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Firebase</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/sqlite-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>SQLite</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/oracle-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Oracle</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/microsoft-sql-server-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Microsoft SQL Server</p>
                                            </div>
                                        </div>
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/amazon-dynamodb-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Amazon DynamoDB</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/mongodb-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>MongoDB</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/apache-couchdb-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Apache CouchDB</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/postgresql-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>PostgreSQL </p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/couchbase-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Couchbase </p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/ravendb-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>RavenDB </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="CMS" role="tabpanel" aria-labelledby="CMS-tab" class="tab-pane fade px-4 py-5">						     <div class="row pt-5">
                                            ...
                                            <div class="col-md-2">
                                                <img src="images/shopifyimg.jpg" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Shopify</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/wordpress-icon.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>WordPress</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/magentoimg.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Magento</p>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
                                    ...
                                    <div id="Tools" role="tabpanel" aria-labelledby="Tools-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/3DS-Max.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>3DS Max</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Autodesk-Maya.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Autodesk Maya</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Blender.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Blender</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Motion-Builder.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Motion Builder</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/sublime-text-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Sublime Text</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/xampp-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>XAMPP</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="Integrations" role="tabpanel" aria-labelledby="Integrations-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            <div class="col-md-2">
                                                <img src="images/Firebase (1).png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Firebase</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/Retrofit.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Retrofit</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/RapidPro.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>RapidPro</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/MVVM.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>MVVM</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/PortWallet.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>PortWallet</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/angaza-technology-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Angaza</p>
                                            </div>
                                        </div>
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-2">
                                                <img src="images/hubspot-icon.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>HubSpot</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/PortWallet (1).png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Xero</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/bkash-technology-logo.png" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>bKash </p>
                                            </div>
                                            <div class="col-md-3">
                                            </div>
                                    ...
                                    <div id="Cloud" role="tabpanel" aria-labelledby="Cloud-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-2">
                                                <img src="images/aws-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>AWS</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/amazon-ec2-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Amazon EC2</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/amazon-s3-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Amazon S3</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/amazon-route-53-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>Amazon Route 53</p>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div id="DevOps" role="tabpanel" aria-labelledby="DevOps-tab" class="tab-pane fade px-4 py-5">
                                        <div class="row pt-5">
                                            ...
                                            <div class="col-md-2">
                                                <img src="images/github-technology-logo-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p>GitHub</p>
                                            </div>
                                            <div class="col-md-2">
                                                <img src="images/cicd-technology-icon-75x75-1.webp" alt="Innovative Technologies We Work" description=" Innovative Technologies We Work">
                                                <p> CI/CD</p>
                                            </div>
                                            <div class="col-md-4">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="top_award_winning_bannar pb-5">
                    <img src="images/awardd.png" alt="Recognized IT Services" description=" Recognized IT Services">
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt="Recognized IT Services" description=" Recognized IT Services">
                    </div>
                </div>
            </div>
        </div>
