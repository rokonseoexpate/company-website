		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Shadow-Making-Service-2.webp" alt=" Shadow Making" description=" Shadow Making" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Shadow-Making-Service-1.webp" alt=" Shadow Making" description=" Shadow Making" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Shadow-Making-Service-3.webp" alt=" Shadow Making" description=" Shadow Making">
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Shadow-Making-Service-4.webp" alt=" Shadow Making" description=" Shadow Making" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Shadow-Making-Service-5.webp" alt=" Shadow Making" description=" Shadow Making" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Shadow-Making-Service-6.webp" alt=" Shadow Making" description=" Shadow Making" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Shadow-Making-Service-2.webp" alt=" Shadow Making" description=" Shadow Making" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
