...
<head>
	...
	<title>Ghost Mannequin Effect</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Ghost-Mannequin-Effect-Service-5.webp" alt=" Ghost Mannequin Effect " description=" Ghost Mannequin Effect " class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Ghost-Mannequin-Effect-Service-2.webp" alt=" seo expate" description=" seo expate">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Ghost-Mannequin-Effect-Service-3.webp" alt=" seo expate" description=" seo expate">
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Ghost-Mannequin-Effect-Service-1.png" alt=" seo expate" description=" seo expate" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Ghost-Mannequin-Effect-Service-4.png" alt=" seo expate" description=" seo expate">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Ghost-Mannequin-Effect-Service-5.webp" alt=" seo expate" description=" seo expate" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Ghost-Mannequin-Effect-Service-6.png" alt=" seo expate" description=" seo expate" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Ghost-Mannequin-Effect-Service.png" alt="image" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
