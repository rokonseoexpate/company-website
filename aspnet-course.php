		    ...
		    <div class="row">
		    	<div class="col-md-7 ecomresp" style="z-index:500; ">
		    		<div class="top_body_txt_part">
						...
						<p style="margin-top: -15px; text-align: justify;">Each framework targets a different development style. The one you choose depends on a combination of your programming assets (knowledge, skills, and development experience), the type of  <a href="app_development.html" class="text-success">application</a> you're creating, and the development approach you're comfortable with.</p>						
					</div>
					<div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="images/ASP.webp" alt=" Web Application Development Using ASP.NET" description=" Web Application Development Using ASP.NET" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
        ...
        <div class="container shadow px-5 py-5">
            <div class="row">
                ...
                <div class="col-12">
                	...
                	<p>3. <a href="web_development.html" class="text-success">Web</a> Forms, Web APIs</p>
                	<p>4. Real-Time Technologies</p>
                	<p>5. <a href="website_course.html" class="text-success">Dynamic Website</a> </p>
