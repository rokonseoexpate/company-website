...
?>
	...
	<section class="top-body web_service" style="background-image: url(images/72d076db-72f4-4121-a467-0195035b7f60.jpg); background-repeat: no-repeat;  background-position: center center; background-size: cover;  margin-top: 60px; ">		
		<div class="container ">
		    <div class="row">
	...
	<div class="our_mission our_promise we_following">
		<div class="container">
			<div class="row">
			<h3 class="text-center pb-2">Benefits of Software Development Services for Small, Medium & Large Businesses</h3>
			<p class="border-bottom border-success border-2 pb-4 mb-5">Software development services offer lots of benefits for businesses of all sizes. Therefore, for small companies, custom software can boost productivity efficiency and help you with the other competitors. Also, medium-sized companies can benefit from solutions that keep up growth, plan operations, and increase production. Large companies can use this service to solve difficult problems, and stay ahead of industry trends. Furthermore, software development services help businesses to grow, adapt to changing market demands, and drive success through technology-driven solutions tailored to their needs.</p>								
				<div class="col-md-6">	
					<h4 class="fs-1 fw-bold">Benefits</h4>	
					<hr class="border-bottom border-danger border-2" style="width: 20%;">			
					<p> <span><i class="fa-solid fa-circle"></i></span>Optimized Business Process</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Scalable AR/VR/MR Solutions</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Improve Accessibility</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Ensure the best combination of skills</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Technical excellence combines with great customer service</p>
				</div>
				<div class="col-md-6">
					<img src="frontend/images/Major-benefits-of-customer-feedback-for-software-development.jpg" alt="image" class="img-thumbnail">
				</div>				
			</div>
		</div>
	</div>
	...
	<div class="our_mission our_promise we_following" style="background: var(--bg-secondary-color);">
		<div class="container">
			<div class="row">
			<h3 class="text-center pb-2">Core Software Development Services</h3>
			<p class="border-bottom border-success border-2 pb-4 mb-5">Our core development services offer you the best solutions for your customized software. Therefore, we collaborate with our customers and create something better for their needs. Our team carefully plans the whole project to finish it without any problems. Also, the development includes properly following the customer's instructions and ensuring it functions properly.  So, these services enable the successful creation and deployment of custom software applications that drive business growth and innovation.</p>	
				<div class="col-md-6">
					<img src="frontend/images/istockphoto-1502289545-612x612.jpg" alt="image" class="img-thumbnail">
				</div>							
				<div class="col-md-6">	
					<h4 class="fs-1 fw-bold">Our Services</h4>	
					<hr class="border-bottom border-danger border-2" style="width: 20%;">			
					<p> <span><i class="fa-solid fa-circle"></i></span>Optimized Business Process</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Convert Manual System to Automate System Improve Accessibility</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Scalable AR/VR/MR Solutions</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Security</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Great customer service</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Ensure the best combination of skills</p>
				</div>								
			</div>
		</div>
	...
	<div class="our_mission our_promise we_following">
		<div class="container">
			<div class="row">
				<h3 class="text-center pb-2">Desktop Software Development Services</h3>
				...
				<div class="col-md-6">	
					<h4 class="fs-2 fw-bold">System Software Development</h4>	
					<hr class="border-bottom border-danger border-2" style="width: 20%;">			
					<p> <span><i class="fa-solid fa-circle"></i></span>System Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Programming Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Cross-platform Desktop App Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Open Source Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Shareware development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Desktop Software Modernization</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Utility Software Development</p>	
				</div>
				<div class="col-md-6">
					<img src="frontend/images/software-developer-6521720_960_720.jpg" alt="image" class="img-thumbnail">
				</div>
				<div class="application pt-3">
						<div class="row">
							<h4 class="fs-2 fw-bold pt-3">Application Software Development</h4>	
							<hr class="border-bottom border-danger border-2">
							<div class="col-md-6">
								<p> <span><i class="fa-solid fa-circle"></i></span> Application Software Development</p>
								<p> <span><i class="fa-solid fa-circle"></i></span> Browsers & Firmware Development</p>
								<p> <span><i class="fa-solid fa-circle"></i></span> Driver Software Development</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>  API Development</p>
							</div>
							<div class="col-md-6">
								<p> <span><i class="fa-solid fa-circle"></i></span>   Security and Assurance</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>Desktop Software Integration</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>Research and Development</p>
							</div>
						</div>
					</div>				
			</div>
	...
	<div class="our_mission our_promise we_following" style="background: var(--bg-secondary-color);">
		<div class="container">
			<div class="row">
				<h3 class="text-center pb-2">Mobile Software Development Services</h3>
				<p class="border-bottom border-success border-2 pb-4 mb-5">Do you need a mobile app and are looking for a mobile software development company? Then, you can have smart mobile app solutions at EO Expate Bangladesh Ltd. If you need simple mobile apps or game development, we have quality mobile app solutions for you. To fulfill your needs, EO Expate Bangladesh Ltd. offers mobile apps development with customization services.Here, you can have mobile app solutions for smartphones, smartwatches, iPhones, iPad, Apple Watch, Android, iOS, Windows Phone, and many more. You can rely on EO Expate Bangladesh Ltd. the most reliable custom software development company. The expert team at EO Expate Bangladesh Ltd. has expertise in Java, J2ME, J2EE, Ajax, PHP, Java, Ruby on Rails, and more to develop your mobile software.</p>	
				<div class="col-md-6">
					<img src="frontend/images/istockphoto-1174690086-612x612.jpg" alt="image" class="img-thumbnail">
				</div>							
				<div class="col-md-6">
					<h4 class="fs-2 fw-bold">Mobile Software Development</h4>	
					<hr class="border-bottom border-danger border-2" style="width: 20%;">				
					<p> <span><i class="fa-solid fa-circle"></i></span>OCustom Mobile Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Cross-platform Mobile Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Hybrid Software Development, Hybrid Mobile App Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Android Mobile Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>iOS Mobile Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Windows Phone Software Development</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Mobile Software Modernization</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Hybrid Software Development</p>					
				</div>
				<div class="ios">
					<div class="row">
						...
						<hr class="border-bottom border-danger border-2">
						<div class="col-md-6">
							<p> <span><i class="fa-solid fa-circle"></i></span> Custom iOS and Android Apps Development</p>
							<p> <span><i class="fa-solid fa-circle"></i></span> eCommerce Mobile App Development</p>
							<p> <span><i class="fa-solid fa-circle"></i></span> Native Mobile App Development, Native Mobile Software</p>
							<p> <span><i class="fa-solid fa-circle"></i></span>  Android Mobile App Development, Mobile Game Development</p>		
						</div>
						<div class="col-md-6">
							<p> <span><i class="fa-solid fa-circle"></i></span> iPad App Development, iPhone App Development</p>
							<p> <span><i class="fa-solid fa-circle"></i></span>Windows Phone App Development</p>
							<p> <span><i class="fa-solid fa-circle"></i></span> UI/UX design, Mobile Apps with Blockchain Integration</p>
							<p> <span><i class="fa-solid fa-circle"></i></span> Hybrid Mobile App Development</p>
						</div>
					</div>
				</div>								
			</div>
	...
	<div class="our_mission our_promise we_following">
		<div class="container">
			<div class="row">
				<h3 class="text-center pb-2">Custom Software Development Services</h3>
				<p class="border-bottom border-success border-2 pb-4 mb-5">The custom software solution provides superior functionality. As a result, Small-to-midsize (SMB) and enterprises can gain a competitive advantage by using custom software. However, suppose you need custom software development services like desktop, web, mobile apps, cloud computing, and more. In that case, SEO Expate Bangladesh Ltd. can offer you the best solution for custom software development. With a proven record in custom software development for large enterprises and organizations, expert developers at SEO Expate Bangladesh Ltd. excel in custom mobile app development, desktop software development, and many more. Let's work together.</p>								
				<div class="col-md-6">	
					<h4 class="fs-2 fw-bold">Custom Enterprise Software Development </h4>	
					<hr class="border-bottom border-danger border-2" style="width: 20%;">			
					<p> <span><i class="fa-solid fa-circle"></i></span>Custom Software Development for New Technologies</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Departmental Software, Customer Self-service Apps</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>UI and UX, Customer Self-service Apps</p>
					<p> <span><i class="fa-solid fa-circle"></i></span>Manufacturing Execution System (MES)</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> SProcurement Platforms</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Inventory Management Software</p>
					<p> <span><i class="fa-solid fa-circle"></i></span> Supply Chain Management (SCM)</p>	
				</div>
				<div class="col-md-6">
					<img src="frontend/images/shutterstock_1171172626.jpg" alt="image" class="img-thumbnail">
				</div>
				<div class="application pt-3">
						<div class="row">
							<h4 class="fs-2 fw-bold pt-3">Custom Mobile App Development </h4>	
							<hr class="border-bottom border-danger border-2">
							<div class="col-md-6">
								<p> <span><i class="fa-solid fa-circle"></i></span> ACorporate & Interorganizational Software Systems</p>
								<p> <span><i class="fa-solid fa-circle"></i></span> Software for a Specific Business Function</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>  Cross-industry, DevOps and QA</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>   Product Life-cycle Management (PLM) Software</p>
							</div>
							<div class="col-md-6">
								<p> <span><i class="fa-solid fa-circle"></i></span> Healthcare Revenue Cycle Management</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>Business Process Management</p>
								<p> <span><i class="fa-solid fa-circle"></i></span>Ecommerce Solutions, Point of Sale (POS) Software</p>
							</div>
						</div>
					</div>				
			</div>
	...
	<section class="accordion_service">
		<div class="container">
			<div class="row">
				<h4 class="text-center pb-5 fs-2">FAQs of Software Development Company and Services</h4>
			    <div id="accordion">
