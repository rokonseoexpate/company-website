		...
		<div class="container ">
		    <div class="row">
				...
				<div class="col-md-5 m-auto ecomrespp" style="z-index:500; ">
					<img src="images/best-python-frameworks-for-web-development.jpg" alt=" Web Development In Python With Django" description=" Web Development In Python With Django" class="img-thumbnail">
				</div>			
			</div>
		</div>				
	</section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="top_ready_start_img text-left">
                        <img src="images/95991_prev_ui.png" alt=" Web Development In Python With Django" description=" Web Development In Python With Django" >
                    </div>
                </div>
            </div>
        </div>
