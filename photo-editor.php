...
?>
	...
	<section class="top_body_text_slider editor_texts">
        <div class="container">
            <div class="row">
                ...
                <div class="tbt_text text-dark">
                    <p>Photo Editing Services for your business. Philippines Photo Editor’s vision is to build people’s business spontaneously by any means. The Philippines Photo Editor doesn’t judge if you own a small or big company. Similarly, we both serve businesses even they operate online or offline. In other words, we care about your photo editing services and make it more profitable through our services. The Philippines Photo Editor has an oath that we will build your company as a brand with visuals and with unique content. Philippines Photo Editor will mainly create your business structure by doing graphics-related works. For that reason, we are offering every type of service that is a must need for an online and offline business.</p>
                </div>                
            </div>
	...
	<section class="top_body_text_slider editor_texts">
        <div class="container">
            <div class="row">
                ...
                <div class="tbt_text text-dark">
                    <p>In other words, Photo editing services included all the image editing services. If you think you need to do editing your photos or images then you can see all the photo editing services. Philippines photo editor company provided you high-quality photo editing service. Philippines photo editor company is one the best photo editing service company in the world. You will get here all the graphic design services at a lower price than other companies.</p>
                </div>                
            </div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Clipping Path Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Clipping-Path-Service-4.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Photo-Background-Removing-Service-3.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Remove Background Image Service</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Image Masking Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/5.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Shadow-Making-Service-1.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Shadow Making Service</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Ghost Mannequin Effect Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Ghost-Mannequin-Effect-Service-5.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Photo-Retouching-Service-4.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Photo Retouching Services</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Color Correction Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Color-Correction-Service-4-1.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/1-1.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>E-Commerce Photo Editing Services</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Jewelry Retouching</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Jewelry-Retouching-Service-3.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/3-2.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Wedding Photo Editing Services</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Photo Restoration Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Photo-Restoration-Service-1.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Real-Estate-Photo-Editing-2.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Real Estate Photo Editing</h4></div>
	...
	<section class="cliping_service photo_edit_all_service">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-2"><h4>Image Manipulation Service</h4></div>
				...
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Image-Manipulation-Service-5.webp" alt="image">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="cliping_service photo_edit_all_service" style="background: unset; ">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="clip_img">
						<img src="frontend/images/Raster-to-Vector-Conversion-Service-1.webp" alt="image">
					</div>
				</div>
				<div class="col-md-6">
					<div class="cliping_service_txt pb-2 pt-3"><h4>Raster To Vector Conversion</h4></div>
	...
	<section class="accordion_service">
		<div class="container">
			<div class="row">
				<h3 class="text-center pb-5">Questions and Answer</h3>
			    <div id="accordion">
