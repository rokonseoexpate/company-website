		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6" style="margin: auto;">
					<div class="clip_img">
						<img src="images/Photo-Restoration-Service-1.webp" alt=" Photo Restoration" description=" Photo Restoration" class="img-thumbnail">
					</div>
				</div>
				<div class="col-12">
		            ...
		            <div class="owl-carousel">
		               <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                        <img src="images/Photo-Restoration-Service-6.png" alt=" Photo Restoration" description=" Photo Restoration">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                  		<img src="images/Photo-Restoration-Service-5.png" alt=" Photo Restoration" description=" Photo Restoration" >
		              		</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Restoration-Service-4.png" alt=" Photo Restoration" description=" Photo Restoration" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Restoration-Service-3.png" alt=" Photo Restoration" description=" Photo Restoration" >
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Restoration-Service-2.png" alt=" Photo Restoration" description=" Photo Restoration">
		                  	</div>
		                </div>
		                <div class="slider-card">
		                  	<div class="d-flex justify-content-center align-items-center mb-4">
		                       <img src="images/Photo-Restoration-Service-1.webp" alt=" Photo Restoration" description=" Photo Restoration" >
		                  	</div>
		                </div>			                	                    
		            </div>
		        </div>
	...
	<section class=" graphicdesigns_content" style="background: var(--bg-secondary-color);">
        <div class="container">
            ...
            <div class="row shadow px-5 py-3">
                ...
                <div class="col-md-4">
                	<img src="images/Photo-Restoration-Service.png" alt=" Photo Restoration" description=" Photo Restoration" class="img-thumbnail">
                </div>               
            </div>
        </div>
    </section>
