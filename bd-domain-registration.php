				...
				<div class="top_about_us_txt" style="z-index:500;">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcumb_gph">
							...
							<li class="breadcrumb-item active text-dark" aria-current="page">/ .BD Domain Registration</li>
						</ol>
					</nav>
				</div>
				<div class="col-md-8">
					<div class="domain_registration_txt">
						...
						<p>If you want to do a website for your educational institute. Of course, you need a .edu.bd domain registration. BTCL (Bangladesh Telecommunication Company Limited) provides .edu.bd domain registration service. We can assist you in registering a domain to BTCL, So <a href="/" class="text-success">SEO Expate</a> Bangladesh Ltd provides all the necessary assistance to register .edu.bd domain for you.</p>
						<h5>Domain Registration Price:</h5>
						<p>.edu.bd or .com.bd domain must be registered for a minimum of 2 years. 2 Years registration charge 18.39$.</p>
						<h5>Domain renew price:</h5>
						<p>You have to renew after 2 years by providing next 2 years price 21.39$.</p>
						...
						<ol>
							<li>Domain registration depends on first order, first-activation basis when payment confirmation. The activation process will be started after successful payment is received by SEO Expate Bangladesh Ltd.</li>
							...
							<li>If the registration is not successful, SEO Expate Bangladesh Ltd will refund the fee.</li>
				...
				<div class="col-md-4">
					...
					<div class="latest_post_right">
						...
						<ul>
							...
							<li><a href="#">Domain hosting ghjghjjhjh in Bangladesh</a></li>
						</ul>
					</div>
					<div class="right_side_banner">
						<img src="frontend/images/300x250.jpg" alt="Domain hosting company" Description="Domain hosting company">
					</div>
