		...
		<div class="container">
			...
			<div class="row pt-5">
				<div class="col-sm-3 contact_info">
					...
					<div class="">
						...
						<p><span><img src="frontend/images/bd-flag.svg" alt="image"></span> +8801409957451</p>
					</div>
					<div class="">
						<h5>Other Contact :</h5>
						<p><span><img src="frontend/images/bd-flag.svg" alt="image"></span> +8801409957452</p>
					</div>
					<div class="footer_top_social_icons">
						<div class="d-flex gap-1">
							<a href="#"><img src="frontend/images/skype.svg" alt="icon"></a>
							<a href="#"><img src="frontend/images/messenger.svg" alt="icon"></a>
							<a href="#"><img src="frontend/images/whatsapp.svg" alt="icon"></a>
						</div>
					</div>
				</div>
				<div class="col-sm-3 contact_info">
			...
			<div class="row text-center pt-5 footer-logos">
				<div class="col-md-2 first_btm_logo">
					<img src="frontend/images/iso-certified.webp" alt="img">
				</div>
				<div class="col-md-2">
					<img src="frontend/images/footer-directory-review-logo-of-clutch.webp" alt="img">
					<p>5.0 • 52 Reviews</p>
				</div>
				<div class="col-md-2">
					<img src="frontend/images/footer-directory-review-logo-of-upcity.webp" alt="img">
					<p>5.0 • 52 Reviews</p>
				</div>
				<div class="col-md-2">
					<img src="frontend/images/footer-directory-review-logo-of-goodfirms.webp" alt="img">
					<p>5.0 • 52 Reviews</p>
				</div>
				<div class="col-md-2">
					<img src="frontend/images/footer-directory-review-logo-of-trustpilot.webp" alt="img">
					<p>5.0 • 52 Reviews</p>
				</div>
				<div class="col-md-2">
					<img src="frontend/images/eng_CHECK_US_273x90.webp" alt="img">
				</div>
			</div>
			<div class="row text-center pt-3 mt-5 footer_bottom">
				...
				<div class="col-md-6 text-right">
					<div class="d-flex gap-2">
						...
						<a href="https://www.facebook.com/seoexpatebdltd"><i class="fa-brands fa-facebook-f"></i></a>
						<!--<a href="#"><i class="fa-brands fa-instagram"></i></a>
						<a href="#"><i class="fa-brands fa-twitter"></i></a> -->
						<a href="https://www.linkedin.com/company/seoexpatebangladeshltd"><i class="fa-brands fa-linkedin-in"></i></a>
						<!-- <a href="#"><i class="fa-brands fa-pinterest-p"></i></a>-->
 						<a href="https://www.youtube.com/@seoexpatebangladeshltd"><i class="fa-brands fa-youtube"></i></a>
						<p>|</p>
						<p>Service Activities : </p>
						<a href="https://www.facebook.com/seoexpatebdltdscervice"><i class="fa-brands fa-facebook-f"></i></a>
						<a href="https://www.linkedin.com/company/seo-expate-bangladesh-ltd-services/"><i class="fa-brands fa-linkedin-in"></i></a>
