                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-content">
                                                        ...
                                                        <div class="list-group">
                                                            <a class="list-group-item d-flex"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p>We count on our technically sound expert
                                                                        developers for the ability to understand your
                                                        ...
                                                        <div class="list-group">
                                                            <a class="list-group-item d-flex"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p>We ensure your vision for a perfect business
                                                                        website with a user-friendly design and
                                                                        appearance to catch emerging technologies and
                                                                        trends.</p>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 py-4">
                                                        <div class="list-group">
                                                            <a class="list-group-item d-flex"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p>We utilize the latest software technologies to
                                                                        develop different custom software with amazing
                                                                        graphics.</p>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="list-group">
                                                            <a class="list-group-item d-flex" href="traning">
                                                                ...
                                                                <div>
                                                                    <h5>Training</h5>
                                                                    <p>We give total instructional classes intended to
                                                                        give a total outline of a specific theme.</p>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-6 py-4">
                                                        ...
                                                        <div class="list-group">
                                                            <a class="list-group-item d-flex" href="#">
                                                                <div><i class="fa-solid fa-code-branch"></i></div>
                                                                <div>
                                                                    <h5>POS Software</h5>
                                                                    <p>We count on our technically sound expert
                                                                        developers for the ability to understand your
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 booknowbtn">
                                <li class="nav-item">
                                    <a type="submit" class="nav-link btn" href="#">Let's Talk</a>
                                </li>
                            </ul>
