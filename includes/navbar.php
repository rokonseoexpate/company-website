		                ...
		                <div class="container-fluid">
		                    ...
		                    <div class="collapse navbar-collapse" id="navbar-content">
		                                            ...
		                                            <div class="row">
		                                                <div class="col-lg-4 col-sm-6 py-4">
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="domain_hosting.php">
		                                                    ...
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="software_development.php">
		                                                    ...
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="seo_service.php">
		                                                ...
		                                                <div class="col-lg-4 col-sm-6 py-4">
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="web_development.php">
		                                                    ...
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="photo_editor.php">
		                                                    ...
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="content_writing.php">
		                                                ...
		                                                <div class="col-lg-4 col-sm-6 py-4">
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="app_development.php">
		                                                    ...
		                                                    <div class="list-group">
		                                                        <a class="list-group-item d-flex" href="digital_marketing.php">
		                                                ...
		                                                <div class="booknowbtn text-center mb-4">
		                                                    <div class="">
		                                                        <a type="submit" class=" btn" href="services.php">More Services</a>
		                                                    </div>
		                                                </div>
		                                            </div>
		                                        </div>
		                        ...
		                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 booknowbtn">
		                            <li class="nav-item">
		                                <a type="submit" class="nav-link btn" href="contact.php">Let's Talk</a>
		                            </li>
		                        </ul>
